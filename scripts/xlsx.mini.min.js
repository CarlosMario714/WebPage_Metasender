...
function make_xlsx_lib(e) {
  ...
  function k(e) {
    ...
    for (var c = 0; c < e.length; ) {
      ...
      r += w.charAt(s) + w.charAt(i) + w.charAt(l) + w.charAt(o);
    }
    return r;
  }
  function y(e) {
    ...
    : function (e) {
        if (typeof Uint8Array !== "undefined") {
          ...
          for (r = 0, t = 0; r < e.length; t += n, ++r) {
            ...
            else if (typeof e[r] == "string") a.set(new Uint8Array(E(e[r])), t);
  ...
  function P(e) {
    ...
    for (var s = 0; s < e.length; ++s) {
      ...
      if (i < 128) n[t++] = i;
        ...
        i = (i & 1023) + 64;
        var l = e.charCodeAt(++s) & 1023;
        n[t++] = 240 | ((i >> 8) & 7);
        n[t++] = 128 | ((i >> 2) & 63);
        n[t++] = 128 | ((l >> 6) & 15) | ((i & 3) << 4);
        n[t++] = 128 | (l & 63);
      } else {
        n[t++] = 224 | ((i >> 12) & 15);
        n[t++] = 128 | ((i >> 6) & 63);
  ...
  function ne(e, r) {
    ...
    return (
      (t - (te + (e.getTimezoneOffset() - re.getTimezoneOffset()) * 6e4)) /
      (24 * 60 * 60 * 1e3)
    );
  }
  function se(e) {
  ...
  function fe(e, r) {
    switch (typeof e) {
      ...
      case "boolean":
        return e ? "TRUE" : "FALSE";
      case "number":
        return (e | 0) === e ? e.toString(10) : ce(e);
      case "undefined":
        return "";
      case "object":
        if (e == null) return "";
        if (e instanceof Date) return Ue(14, ne(e, r && r.date1904), r);
    }
  ...
  function he(e, r, t, a) {
    ...
    switch (e) {
      ...
      case 115:
        ...
        if (t.u === 0 && (r == "s" || r == "ss")) return B(t.S, r.length);
        if (a >= 2) i = a === 3 ? 1e3 : 100;
        else i = a === 1 ? 10 : 1;
        s = Math.round(i * (t.S + t.u));
        if (s >= 60 * i) s = 0;
        if (r === "s") return s === 0 ? "0" : "" + s / i;
        n = B(s, 2 + a);
  ...
  function pe(e, r, t) {
    var a = r.replace(me, ""),
      n = r.length - a.length;
    return Pe(e, a, t * Math.pow(10, 2 * n)) + Cr("%", n);
  }
  function ve(e, r, t) {
    var a = r.length - 1;
    while (r.charCodeAt(a - 1) === 44) --a;
    return Pe(e, r.substr(0, a), t / Math.pow(10, 3 * (r.length - a)));
  }
  function ge(e, r) {
    var t;
  ...
  function we(e, r, t) {
    ...
    return (
      ...
      " " +
      (i === 0
        ? Cr(" ", e[1].length + 1 + e[4].length)
        : z(i, e[1].length) + e[2] + "/" + e[3] + B(l, e[4].length))
    );
  }
  function ke(e, r, t) {
  ...
  function Te(e, r, t) {
    if (e.charCodeAt(0) === 40 && !r.match(xe)) {
      var a = r.replace(/\( */, "").replace(/ \)/, "").replace(/\)/, "");
      if (t >= 0) return Te("n", a, t);
      return "(" + Te("n", a, -t) + ")";
    }
    ...
    if (r.charCodeAt(0) === 36)
      return "$" + Te(e, r.substr(r.charAt(1) == " " ? 2 : 1), t);
    var n;
    var s,
      i,
      l,
    ...
    if ((s = r.match(be))) return we(s, o, c);
    if (r.match(/^#+0+$/)) return c + V(o, r.length - r.indexOf("0"));
    if ((s = r.match(ye))) {
      n = _e(t, s[1].length)
        .replace(/^([^\.]+)$/, "$1." + Ce(s[1]))
        .replace(/\.$/, "." + Ce(s[1]))
        .replace(/\.(\d*)$/, function (e, r) {
          return "." + r + Cr("0", Ce(s[1]).length - r.length);
        });
    ...
    if ((s = r.match(/^#{1,3},##0(\.?)$/))) return c + de(V(o, 0));
    if ((s = r.match(/^#,##0\.([#0]*0)$/))) {
      return t < 0
        ? "-" + Te(e, r, -t)
        : de("" + (Math.floor(t) + Fe(t, s[1].length))) +
            "." +
            B(Ae(t, s[1].length), s[1].length);
    }
    if ((s = r.match(/^#,#*,#0/))) return Te(e, r.replace(/^#,#*,/, ""), t);
    if ((s = r.match(/^([0#]+)(\\?-([0#]+))+$/))) {
      n = L(Te(e, r.replace(/[\\-]/g, ""), t));
      i = 0;
      return L(
        L(r.replace(/\\/g, "")).replace(/[0#]/g, function (e) {
          return i < n.length ? n.charAt(i++) : e === "0" ? "0" : "";
        })
      );
    }
    if (r.match(Se)) {
    ...
    if ((s = r.match(/^([#0?]+)( ?)\/( ?)([#0?]+)/))) {
      ...
      l = Q(o, Math.pow(10, i) - 1, false);
      n = "" + c;
      f = Pe("n", s[1], l[1]);
      if (f.charAt(f.length - 1) == " ") f = f.substr(0, f.length - 1) + "0";
      n += f + s[2] + "/" + s[3];
      f = W(l[2], i);
      if (f.length < s[4].length)
        f = Ce(s[4].substr(s[4].length - f.length)) + f;
      n += f;
      return n;
    }
    if ((s = r.match(/^# ([#0?]+)( ?)\/( ?)([#0?]+)/))) {
      i = Math.min(Math.max(s[1].length, s[4].length), 7);
      l = Q(o, Math.pow(10, i) - 1, true);
      return (
        c +
        (l[0] || (l[1] ? "" : "0")) +
        " " +
        (l[1]
          ? z(l[1], i) + s[2] + "/" + s[3] + W(l[2], i)
          : Cr(" ", 2 * i + 1 + s[2].length + s[3].length))
      );
    }
    if ((s = r.match(/^[#0?]+$/))) {
      n = V(t, 0);
      ...
      return t < 0
        ...
        : de(Ee(t))
            ...
            .replace(/^\d*$/, function (e) {
              return "00," + (e.length < 3 ? B(0, 3 - e.length) : "") + e;
            }) +
            "." +
            B(i, s[1].length);
    }
  ...
  function Ne(e, r, t) {
    ...
    if (r.charCodeAt(0) === 36)
      return "$" + Ne(e, r.substr(r.charAt(1) == " " ? 2 : 1), t);
    var n;
    var s,
      i,
      l,
    ...
    if ((s = r.match(be))) return ke(s, o, c);
    if (r.match(/^#+0+$/)) return c + B(o, r.length - r.indexOf("0"));
    if ((s = r.match(ye))) {
      n = ("" + t)
        .replace(/^([^\.]+)$/, "$1." + Ce(s[1]))
        .replace(/\.$/, "." + Ce(s[1]));
    ...
    if ((s = r.match(/^#{1,3},##0(\.?)$/))) return c + de("" + o);
    if ((s = r.match(/^#,##0\.([#0]*0)$/))) {
      return t < 0
        ? "-" + Ne(e, r, -t)
        : de("" + t) + "." + Cr("0", s[1].length);
    }
    if ((s = r.match(/^#,#*,#0/))) return Ne(e, r.replace(/^#,#*,/, ""), t);
    if ((s = r.match(/^([0#]+)(\\?-([0#]+))+$/))) {
      n = L(Ne(e, r.replace(/[\\-]/g, ""), t));
      i = 0;
      return L(
        L(r.replace(/\\/g, "")).replace(/[0#]/g, function (e) {
          return i < n.length ? n.charAt(i++) : e === "0" ? "0" : "";
    ...
    switch (r) {
      ...
      default:
        if (r.match(/\.[0#?]*$/))
          return (
            Ne(e, r.slice(0, r.lastIndexOf(".")), t) +
            Ce(r.slice(r.lastIndexOf(".")))
          );
    }
    throw new Error("unsupported format |" + r + "|");
  }
  function Pe(e, r, t) {
    return (t | 0) === t ? Ne(e, r, t) : Te(e, r, t);
  }
  function Ie(e) {
    var r = [];
    var t = false;
  ...
  function Be(e, r, t, a) {
    ...
    while (i < e.length) {
      switch ((l = e.charAt(i))) {
        case "G":
          ...
          break;
        case '"':
          for (s = ""; (u = e.charCodeAt(++i)) !== 34 && i < e.length; )
        ...
        case "b":
          if (e.charAt(i + 1) === "1" || e.charAt(i + 1) === "2") {
            if (c == null) {
              c = ee(r, t, e.charAt(i + 1) === "2");
              if (c == null) return "";
            }
            n[n.length] = { t: "X", v: e.substr(i, 2) };
            o = l;
            i += 2;
            break;
          }
        ...
        case "g":
          ...
          s = l;
          while (++i < e.length && e.charAt(i).toLowerCase() === l) s += l;
        ...
        case "ä¸Š":
          ...
          if (e.substr(i, 3).toUpperCase() === "A/P") {
            if (c != null) p.v = c.H >= 12 ? e.charAt(i + 2) : l;
            p.t = "T";
            h = "h";
            i += 3;
            ...
            i += 5;
            h = "h";
          } else if (e.substr(i, 5).toUpperCase() === "ä¸Šåˆ/ä¸‹åˆ") {
        ...
        case "[":
          s = l;
          while (e.charAt(i++) !== "]" && i < e.length) s += e.charAt(i);
          ...
          if (s.match(Re)) {
            ...
            n[n.length] = { t: "Z", v: s.toLowerCase() };
            o = s.charAt(1);
          } else if (s.indexOf("$") > -1) {
            s = (s.match(/\$([^-\[\]]*)/) || [])[1] || "$";
            if (!Le(e)) n[n.length] = { t: "t", v: s };
          }
          break;
        case ".":
          if (c != null) {
            s = l;
            while (++i < e.length && (l = e.charAt(i)) === "0") s += l;
            n[n.length] = { t: "s", v: s };
            break;
          }
        case "0":
        case "#":
          s = l;
          while (++i < e.length && "0#?.,E+-%".indexOf((l = e.charAt(i))) > -1)
            s += l;
          n[n.length] = { t: "n", v: s };
          break;
        case "?":
          s = l;
          while (e.charAt(++i) === l) s += l;
          n[n.length] = { t: l, v: s };
          o = l;
          break;
        case "*":
          ++i;
          if (e.charAt(i) == " " || e.charAt(i) == "*") ++i;
          break;
        case "(":
        case ")":
    ...
    for (i = n.length - 1, o = "t"; i >= 0; --i) {
      switch (n[i].t) {
        ...
        case "H":
          ...
          break;
        case "s":
          if ((b = n[i].v.match(/\.0+$/))) g = Math.max(g, b[0].length - 1);
          if (v < 3) v = 3;
        case "d":
        case "y":
        case "M":
        ...
        case "X":
          break;
        case "Z":
          if (v < 1 && n[i].v.match(/[Hh]/)) v = 1;
          if (v < 2 && n[i].v.match(/[Mm]/)) v = 2;
          if (v < 3 && n[i].v.match(/[Ss]/)) v = 3;
      }
    }
    switch (v) {
      case 0:
    ...
    for (i = 0; i < n.length; ++i) {
      switch (n[i].t) {
        ...
        case "b":
        case "Z":
          n[i].v = he(n[i].t.charCodeAt(0), n[i].v, c, g);
          n[i].t = "t";
          break;
        case "n":
        case "?":
    ...
    if (w.length > 0) {
      ...
      if (C === n.length && S.indexOf("E") === -1) {
        for (i = n.length - 1; i >= 0; --i) {
          if (n[i] == null || "n?".indexOf(n[i].t) === -1) continue;
          if (k >= n[i].v.length - 1) {
            k -= n[i].v.length;
            n[i].v = S.substr(k + 1, n[i].v.length);
          } else if (k < 0) n[i].v = "";
          else {
            n[i].v = S.substr(0, k + 1);
            k = -1;
          }
          n[i].t = "t";
          _ = i;
        }
        if (k >= 0 && _ < n.length) n[_].v = S.substr(0, k + 1) + n[_].v;
        ...
        for (i = C; i >= 0; --i) {
          ...
          for (; f >= 0; --f) {
            if (
              k >= 0 &&
              (n[i].v.charAt(f) === "0" || n[i].v.charAt(f) === "#")
            )
              y = S.charAt(k--) + y;
          }
          n[i].v = y;
        ...
        if (k >= 0 && _ < n.length) n[_].v = S.substr(0, k + 1) + n[_].v;
        k = S.indexOf(".") + 1;
        for (i = C; i < n.length; ++i) {
          if (n[i] == null || ("n?(".indexOf(n[i].t) === -1 && i !== C))
            continue;
          f = n[i].v.indexOf(".") > -1 && i === C ? n[i].v.indexOf(".") + 1 : 0;
          y = n[i].v.substr(0, f);
          for (; f < n[i].v.length; ++f) {
            if (k < S.length) y += S.charAt(k++);
          }
          n[i].v = y;
          n[i].t = "t";
          _ = i;
    ...
    for (i = 0; i < n.length; ++i)
      if (n[i] != null && "n?".indexOf(n[i].t) > -1) {
        x = a > 1 && r < 0 && i > 0 && n[i - 1].v === "-" ? -r : r;
        n[i].v = Pe(n[i].t, n[i].v, x);
        n[i].t = "t";
      }
    var A = "";
    for (i = 0; i !== n.length; ++i) if (n[i] != null) A += n[i].v;
    return A;
  }
  var ze = /\[(=|>[=]?|<[>=]?)(-?\d+(?:\.\d*)?)\]/;
  function $e(e, r) {
  ...
  function Ue(e, r, t) {
    ...
    switch (typeof e) {
      ...
      case "number":
        ...
        else a = (t.table != null ? t.table : K)[e];
        if (a == null) a = (t.table && t.table[Z[e]]) || K[Z[e]];
        if (a == null) a = q[e] || "General";
        break;
    }
    if (X(a, 0)) return fe(r, t);
    if (r instanceof Date) r = ne(r, t.date1904);
    var n = We(a, r);
    if (X(n[1])) return fe(r, t);
    if (r === true) r = "TRUE";
    else if (r === false) r = "FALSE";
    else if (r === "" || r == null) return "";
    return Be(n[1], r, t, n[0]);
  }
  function je(e, r) {
    if (typeof r != "number") {
      r = +r || -1;
  ...
  function He(e) {
    for (var r = 0; r != 392; ++r) if (e[r] !== undefined) je(e[r], r);
  }
  function Ve() {
    K = J();
  }
  ...
  function Ke(e, r, t) {
    ...
    var f =
      ...
      ":" +
      ("00" + (o >= 0 ? o : 0)).slice(-2);
    if (i == -1 && l == -1 && o == -1) return c;
    if (a == -1 && n == -1 && s == -1) return f;
    return c + "T" + f;
  }
  var Ze = { "d.m": "d\\.m" };
  function qe(e, r) {
  ...
  var Qe = (function () {
    ...
    function x(e, r) {
      var a = r ^ -1;
      for (var n = 0, s = e.length, i = 0, l = 0; n < s; ) {
        i = e.charCodeAt(n++);
        if (i < 128) {
          a = (a >>> 8) ^ t[(a ^ i) & 255];
        } else if (i < 2048) {
          a = (a >>> 8) ^ t[(a ^ (192 | ((i >> 6) & 31))) & 255];
          a = (a >>> 8) ^ t[(a ^ (128 | (i & 63))) & 255];
        } else if (i >= 55296 && i < 57344) {
          i = (i & 1023) + 64;
          l = e.charCodeAt(n++) & 1023;
          a = (a >>> 8) ^ t[(a ^ (240 | ((i >> 8) & 7))) & 255];
          a = (a >>> 8) ^ t[(a ^ (128 | ((i >> 2) & 63))) & 255];
          a =
            (a >>> 8) ^ t[(a ^ (128 | ((l >> 6) & 15) | ((i & 3) << 4))) & 255];
          a = (a >>> 8) ^ t[(a ^ (128 | (l & 63))) & 255];
        } else {
          a = (a >>> 8) ^ t[(a ^ (224 | ((i >> 12) & 15))) & 255];
          a = (a >>> 8) ^ t[(a ^ (128 | ((i >> 6) & 63))) & 255];
          a = (a >>> 8) ^ t[(a ^ (128 | (i & 63))) & 255];
        }
      }
      return ~a;
  ...
  var er = (function Tc() {
      ...
      while (e.l <= e.length - 4) {
        ...
        switch (a) {
          case 21589:
            {
              t = e._R(1);
              if (t & 1) i.mtime = e._R(4);
              if (n > 5) {
                if (t & 2) i.atime = e._R(4);
                if (t & 4) i.ctime = e._R(4);
              }
              if (i.mtime) i.mt = new Date(i.mtime * 1e3);
            }
            break;
          case 1:
            {
              var l = e._R(4),
                o = e._R(4);
              i.usz = o * Math.pow(2, 32) + l;
              l = e._R(4);
              o = e._R(4);
              i.csz = o * Math.pow(2, 32) + l;
            }
            break;
        }
        e.l = s;
    ...
    function c(e, r) {
      ...
      if ((e[0] | 32) == 109 && (e[1] | 32) == 105) return $e(e, r);
      if (e.length < 512)
      ...
      p(o, s, S, a, c);
      var C = g(S, i, c, a);
      if (i < C.length) C[i].name = "!Directory";
      if (n > 0 && l !== B) C[l].name = "!MiniFAT";
      C[c[0]].name = "!FAT";
      C.fat_addrs = c;
      C.ssz = a;
      var _ = {},
      ...
      d(F, E, A);
      A.shift();
      var T = { FileIndex: F, FullPaths: E };
      if (r && r.raw) T.raw = { header: w, sectors: S };
      return T;
    }
    function f(e) {
      if (e[e.l] == 80 && e[e.l + 1] == 75) return [0, 0];
      e.chk(z, "Header Signature: ");
      e.l += 16;
      var r = e._R(2, "u");
      return [e._R(2, "u"), r];
    }
    ...
    function m(e, r, t) {
      ...
      var i = a;
      while (t && n > 0 && i >= 0) {
        s.push(r.slice(i * L, i * L + L));
        n -= L;
        i = ca(t, i * 4);
      }
      if (s.length === 0) return wa(0);
      return N(s).slice(0, e.size);
    }
    function p(e, r, t, a, n) {
      ...
      if (e === B) {
        ...
        if (!i) return;
        for (var o = 0; o < l; ++o) {
          if ((s = ca(i, o * 4)) === B) break;
          n.push(s);
        }
        if (r >= 1) p(ca(i, a - 4), r - 1, t, a, n);
      }
    }
    ...
    function g(e, r, t, a) {
      ...
      for (f = 0; f < n; ++f) {
        ...
        s[h] = { nodes: l, data: Bt([o]) };
      }
      return s;
    }
    function b(e, r, t, a, n, s, i, l) {
      var o = 0,
        c = a.length ? 2 : 0;
      var f = r[e].data;
      var u = 0,
      ...
      for (; u < f.length; u += 128) {
        ...
        if (b !== 0) g.ct = w(p, p.l - 8);
        var k = p._R(2) + p._R(2) + p._R(2) + p._R(2);
        if (k !== 0) g.mt = w(p, p.l - 8);
        g.start = p._R(4, "i");
        g.size = p._R(4, "i");
        ...
        if (g.type === 5) {
          ...
          if (g.size < 0) g.size = 0;
            ...
            g.content = m(g, r[o].data, (r[l] || {}).data);
          }
        }
    ...
    function O(e, n) {
      ...
      for (var l = e.FullPaths.length - 1; l >= 0; --l) {
        ...
        switch (o.type) {
          ...
          case 5:
            i = true;
            if (isNaN(o.R * o.L * o.C)) s = true;
            if (o.R > -1 && o.L > -1 && o.R == o.L) s = true;
            break;
          default:
            s = true;
            break;
      ...
      for (l = 0; l < h.length; ++l) {
        ...
        if (l === 0) {
          ...
          for (f = l + 1; f < h.length; ++f) if (t(e.FullPaths[f]) == p) break;
          m.C = f >= h.length ? -1 : f;
          ...
          if (t(e.FullPaths[l + 1] || "") == t(p)) m.R = l + 1;
          m.type = 2;
        }
      }
    }
    function M(e, r) {
      var t = r || {};
      if (t.fileType == "mad") return We(e, t);
      O(e);
      switch (t.fileType) {
        case "zip":
          return Ne(e, t);
      ...
      var s = 0,
        i = 0;
      {
        for (s = 0; s < 8; ++s) n._W(1, $[s]);
        for (s = 0; s < 8; ++s) n._W(2, 0);
        n._W(2, 62);
        n._W(2, 3);
        n._W(2, 65534);
        n._W(2, 9);
        n._W(2, 6);
        for (s = 0; s < 3; ++s) n._W(2, 0);
        n._W(4, 0);
        n._W(4, a[2]);
        ...
        n._W(-4, a[1] ? a[0] - 1 : B);
        n._W(4, a[1]);
        for (s = 0; s < 109; ++s) n._W(-4, s < a[2] ? a[1] + s : -1);
      }
      if (a[1]) {
        for (i = 0; i < a[1]; ++i) {
          for (; s < 236 + i * 127; ++s) n._W(-4, s < a[2] ? a[1] + s : -1);
          n._W(-4, i === a[1] - 1 ? B : i + 1);
        }
      }
      var l = function (e) {
        for (i += e; s < i - 1; ++s) n._W(-4, s + 1);
        if (e) {
          ++s;
          n._W(-4, B);
        }
      ...
      i = s = 0;
      for (i += a[1]; s < i; ++s) n._W(-4, U.DIFSECT);
      for (i += a[2]; s < i; ++s) n._W(-4, U.FATSECT);
      l(a[3]);
      l(a[4]);
      var o = 0,
        c = 0;
      ...
      l((a[6] + 7) >> 3);
      while (n.l & 511) n._W(-4, U.ENDOFCHAIN);
      i = s = 0;
      ...
      for (s = 0; s < a[4] << 2; ++s) {
        ...
        f = e.FileIndex[s];
        if (s === 0) f.start = f.size ? f.start - 1 : B;
        var h = (s === 0 && t.root) || f.name;
        if (h.length > 32) {
          console.error(
      ...
      for (s = 1; s < e.FileIndex.length; ++s) {
        ...
        if (f.size >= 4096) {
          n.l = (f.start + 1) << 9;
          if (S && Buffer.isBuffer(f.content)) {
    ...
    function P(e, r) {
      ...
      if (i !== -1) return e.FileIndex[i];
      var l = !s.match(R);
      s = s.replace(I, "");
      if (l) s = s.replace(R, "!");
      for (i = 0; i < t.length; ++i) {
        if ((l ? t[i].replace(R, "!") : t[i]).replace(I, "") == s)
          return e.FileIndex[i];
        if ((l ? a[i].replace(R, "!") : a[i]).replace(I, "") == s)
          return e.FileIndex[i];
      }
      return null;
    }
    ...
    function V(e, r) {
      ...
      switch ((r && r.type) || "buffer") {
        ...
        case "base64":
          return k(typeof t == "string" ? t : H(t));
        case "buffer":
          if (S) return Buffer.isBuffer(t) ? t : C(t);
        case "array":
    ...
    function ce(e, r, t) {
      ...
      if (t < 8 - a) return i & s;
      i |= e[n + 1] << (8 - a);
      if (t < 16 - a) return i & s;
      i |= e[n + 2] << (16 - a);
      if (t < 24 - a) return i & s;
      i |= e[n + 3] << (24 - a);
      return i & s;
    }
    function fe(e, r, t) {
    ...
    function ve(e, r, t) {
      ...
      for (s = o; s < t; ++s) e[s] = 0;
      o = e.length;
      var f = ee ? new Uint16Array(o) : pe(o);
      for (s = 0; s < o; ++s) {
        c[(n = e[s])]++;
        if (a < n) a = n;
        f[s] = 0;
      ...
      c[0] = 0;
      for (s = 1; s <= a; ++s) c[s + 16] = l = (l + c[s - 1]) << 1;
      for (s = 0; s < o; ++s) {
        l = e[s];
        if (l != 0) f[s] = c[l + 16]++;
      }
      ...
      for (s = 0; s < o; ++s) {
        ...
        if (u != 0) {
          l = ae(f[s], a) >> (a - u);
          for (i = (1 << (a + 4 - u)) - 1; i >= 0; --i)
            r[l | (i << u)] = (u & 15) | (s << 4);
        }
      }
      return a;
    }
    var ge = ee ? new Uint16Array(512) : pe(512);
    ...
    var ke = (function Ge() {
      ...
      function s(r, t) {
        ...
        while (s < r.length) {
          var l = Math.min(65535, r.length - s);
          if (l < 10) {
            n = fe(t, n, +!!(s + l == r.length));
            if (n & 7) n += 8 - (n & 7);
            t.l = (n / 8) | 0;
            t._W(2, l);
            t._W(2, ~l & 65535);
          ...
          while (l-- > 0) {
            ...
            if ((f = i[o])) {
              f |= s & ~32767;
              if (f > s) f -= 32768;
              if (f < s) while (r[f + u] == r[s + u] && u < 250) ++u;
            }
            if (u > 2) {
              c = a[u];
    ...
    var xe = ee ? new Uint16Array(32768) : pe(32768);
    ...
    function Fe(e, r) {
      ...
      for (h = 0; h < u; ++h) if ((d = i[h]) != 0) l[h] = f[d]++;
      var m = 0;
      for (h = 0; h < u; ++h) {
        m = i[h];
        if (m != 0) {
    ...
    function Me(e, r, t, a, n) {
      ...
      var m = e._R(2);
      var p = "";
      for (var v = 0; v < d; ++v) p += String.fromCharCode(e[e.l++]);
      if (m) {
        var g = i(e.slice(e.l, e.l + m));
    ...
    function Ne(e, r) {
      ...
      for (f = 1; f < e.FullPaths.length; ++f) {
        p = e.FullPaths[f].slice(m.length);
        v = e.FileIndex[f];
        if (!v.size || !v.content || p == "Sh33tJ5") continue;
        var w = h;
        var k = wa(p.length);
        ...
        g[d] =
          typeof v.content == "string"
            ? Qe.bstr(v.content, 0)
            : Qe.buf(v.content, 0);
        var y = typeof v.content == "string" ? E(v.content) : v.content;
        if (l == 8) y = J(y);
        i = wa(30);
        i._W(4, 67324752);
        i._W(2, 20);
        ...
        i._W(-4, o & 8 ? 0 : g[d]);
        i._W(4, o & 8 ? 0 : y.length);
        i._W(4, o & 8 ? 0 : v.content.length);
        i._W(2, k.length);
        i._W(2, 0);
        h += i.length;
        a.push(i);
    ...
    function ze(e, r, t) {
      ...
      var f = je(e, a.slice(t.length), i, { unsafe: true });
      if (s) f.ctype = s;
    }
    function $e(e, r) {
      ...
      for (n = 0; n < a.length; ++n) {
        s = a[n];
        if (!/^Content-Location:/i.test(s)) continue;
        s = s.slice(s.indexOf("file"));
        if (!t) t = s.slice(0, s.lastIndexOf("/") + 1);
        if (s.slice(0, t.length) == t) continue;
        while (t.length > 0) {
          t = t.slice(0, t.length - 1);
          t = t.slice(0, t.lastIndexOf("/") + 1);
          if (s.slice(0, t.length) == t) break;
        }
      }
    ...
    function We(e, r) {
      ...
      for (var o = 1; o < e.FullPaths.length; ++o) {
        ...
        l = e.FileIndex[o];
        if (!l.size || !l.content || i == "Sh33tJ5") continue;
        i = i
        ...
        var u = 0,
          ...
          d = 0;
        for (var m = 0; m <= h; ++m)
          if ((d = f.charCodeAt(m)) >= 32 && d < 128) ++u;
        var p = u >= (h * 4) / 5;
        n.push(a);
  ...
  function nr(e, r, t) {
    if (typeof rr !== "undefined" && rr.writeFileSync)
      return t ? rr.writeFileSync(e, r, t) : rr.writeFileSync(e, r);
  ...
  var ur = new Date(1899, 11, 30, 0, 0, 0);
  function hr(e, r) {
    var t = e.getTime();
    if (r) t -= 1462 * 24 * 60 * 60 * 1e3;
    var a =
      ur.getTime() + (e.getTimezoneOffset() - ur.getTimezoneOffset()) * 6e4;
    return (t - a) / (24 * 60 * 60 * 1e3);
  }
  var dr = new Date();
  var mr =
    ur.getTime() + (dr.getTimezoneOffset() - ur.getTimezoneOffset()) * 6e4;
  var pr = dr.getTimezoneOffset();
  function vr(e) {
    var r = new Date();
    r.setTime(e * 24 * 60 * 60 * 1e3 + mr);
    if (r.getTimezoneOffset() !== pr) {
      r.setTime(r.getTime() + (r.getTimezoneOffset() - pr) * 6e4);
    }
    return r;
  }
  function gr(e) {
  ...
  function xr(e, r) {
    if (S && Buffer.isBuffer(e)) {
      if (r && _) {
        if (e[0] == 255 && e[1] == 254)
          return gt(e.slice(2).toString("utf16le"));
        if (e[1] == 254 && e[2] == 255)
          return gt(h(e.slice(2).toString("binary")));
      }
    ...
    var n = [];
    for (var s = 0; s != e.length; ++s) n.push(String.fromCharCode(e[s]));
    return n.join("");
  }
  function Sr(e) {
    ...
    var r = {};
    for (var t in e)
      if (Object.prototype.hasOwnProperty.call(e, t)) r[t] = Sr(e[t]);
    return r;
  }
  function Cr(e, r) {
    var t = "";
  ...
  function Tr(e) {
    ...
    if (r.match(/jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec/)) {
      ...
      if (r.length > 3 && Er.indexOf(r) == -1) return s;
    } else if (r.replace(/[ap]m?/, "").match(/[a-z]/)) return s;
    if (i < 0 || i > 8099 || e.match(/[^-0-9:,\/\\]/)) return s;
    return n;
  }
  var Dr = (function () {
  ...
  function Or(e) {
    if (!e) return null;
    if (e.content && e.type) return xr(e.content, true);
    if (e.data) return d(e.data);
    if (e.asNodeBuffer && S) return d(e.asNodeBuffer().toString("binary"));
    if (e.asBinary) return d(e.asBinary());
    if (e._data && e._data.getContent)
      return d(xr(Array.prototype.slice.call(e._data.getContent(), 0)));
    return null;
  }
  function Mr(e) {
    if (!e) return null;
  ...
  function Nr(e) {
    return e && e.name.slice(-4) === ".bin" ? Mr(e) : Or(e);
  }
  function Pr(e, r) {
  ...
  var Hr = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>\r\n';
  var Vr =
    /([^"\s?>\/]+)\s*=\s*((?:")([^"]*)(?:")|(?:')([^']*)(?:')|([^'">\s]+))/g;
  var Xr =
  ...
  function Zr(e, r, t) {
    ...
    var n = 0,
      s = 0;
    for (; n !== e.length; ++n)
      if ((s = e.charCodeAt(n)) === 32 || s === 10 || s === 13) break;
    ...
    if (i)
      for (c = 0; c != i.length; ++c) {
        u = i[c];
        for (s = 0; s != u.length; ++s) if (u.charCodeAt(s) === 61) break;
        f = u.slice(0, s).trim();
        while (u.charCodeAt(s + 1) == 32) ++s;
        h = (n = u.charCodeAt(s + 1)) == 34 || n == 39 ? 1 : 0;
        o = u.slice(s + 1 + h, u.length - h);
  ...
  var pt = "foo bar bazÃ¢Â˜ÂƒÃ°ÂŸÂÂ£";
  ...
  function St(e, r) {
    ...
    a.forEach(function (e) {
      var r = e.replace(yt, "").match(xt);
      if (r) n.push({ v: vt(r[2]), t: r[1] });
    });
    return n;
  }
  var Ct = /(^\s|\s$|\n)/;
  ...
  function Ft(e, r, t) {
    return (
      ...
      (t != null ? At(t) : "") +
      (r != null
        ? (r.match(Ct) ? ' xml:space="preserve"' : "") + ">" + r + "</" + e
        : "/") +
      ">"
    );
  }
  ...
  function Tt(e, r) {
    switch (typeof e) {
      case "string":
        ...
        return t;
      case "number":
        return Ft((e | 0) == e ? "vt:i4" : "vt:r8", nt(String(e)));
      case "boolean":
        return Ft("vt:bool", e ? "true" : "false");
    }
    if (e instanceof Date) return Ft("vt:filetime", Et(e));
  ...
  function It(e, r) {
    ...
    var n = e[r + 6] & 15;
    for (var s = 5; s >= 0; --s) n = n * 256 + e[r + s];
  ...
  function Rt(e, r, t) {
    ...
    for (var l = 0; l <= 5; ++l, s /= 256) e[t + l] = s & 255;
    e[t + 6] = ((n & 15) << 4) | (s & 15);
    e[t + 7] = (n >> 4) | a;
  }
  var Lt = function (e) {
    ...
    for (var a = 0; a < e[0].length; ++a)
      if (e[0][a])
        for (var n = 0, s = e[0][a].length; n < s; n += t)
  ...
  var zt = function (e, r, t) {
    var a = [];
    for (var n = r; n < t; n += 2) a.push(String.fromCharCode(ia(e, n)));
    return a.join("").replace(I, "");
  };
  var $t = S
    ? function (e, r, t) {
        if (!Buffer.isBuffer(e) || !_) return zt(e, r, t);
  ...
  var Ut = S
    ? function (e, r, t) {
        return Buffer.isBuffer(e) ? e.toString("hex", r, r + t) : Wt(e, r, t);
      }
    : Wt;
  var jt = function (e, r, t) {
    var a = [];
    for (var n = r; n < t; n++) a.push(String.fromCharCode(sa(e, n)));
    return a.join("");
  };
  var Ht = S
    ? function Dc(e, r, t) {
  ...
  if (S) {
    ...
    Kt = function Ic(e, r) {
      if (!Buffer.isBuffer(e) || !_) return Jt(e, r);
      var t = 2 * e.readUInt32LE(r);
      return e.toString("utf16le", r + 4, r + 4 + t - 1);
    };
    qt = function Rc(e, r) {
      if (!Buffer.isBuffer(e) || !_) return Zt(e, r);
      var t = e.readUInt32LE(r);
  ...
  function na() {
    $t = function (e, r, t) {
      return a.utils.decode(1200, e.slice(r, t)).replace(I, "");
    };
    Ht = function (e, r, t) {
  ...
  function ua(e, t) {
    ...
    switch (t) {
      case "dbcs":
        u = this.l;
        if (S && Buffer.isBuffer(this) && _)
          n = this.slice(this.l, this.l + 2 * e).toString("utf16le");
        else
          for (f = 0; f < e; ++f) {
            n += String.fromCharCode(ia(this, u));
            u += 2;
          }
        e *= 2;
        break;
      ...
      case "wstr":
        ...
        else return ua.call(this, e, "dbcs");
        e = 2 * e;
        break;
      case "lpstr-ansi":
        n = Xt(this, this.l);
      ...
      case "cstr":
        e = 0;
        n = "";
        while ((o = sa(this, this.l + e++)) !== 0) l.push(m(o));
        n = l.join("");
        break;
      case "_wstr":
        e = 0;
        n = "";
        while ((o = ia(this, this.l + e)) !== 0) {
          l.push(m(o));
          e += 2;
        }
        e += 2;
      ...
      case "dbcs-cont":
        ...
        for (f = 0; f < e; ++f) {
          if (this.lens && this.lens.indexOf(u) !== -1) {
            o = sa(this, u);
            this.l = u + 1;
            c = ua.call(this, e - f, o ? "dbcs-cont" : "sbcs-cont");
            return l.join("") + c;
          }
          l.push(m(ia(this, u)));
          u += 2;
      ...
      default:
        switch (e) {
          case 1:
            ...
            return s;
          case 2:
            s = (t === "i" ? la : ia)(this, this.l);
            this.l += 2;
            return s;
          case 4:
          case -4:
            if (t === "i" || (this[this.l + 3] & 128) === 0) {
              s = (e > 0 ? ca : fa)(this, this.l);
              this.l += 4;
              return s;
            } else {
              i = oa(this, this.l);
  ...
  function pa(e, n, s) {
    var i = 0,
      l = 0;
    if (s === "dbcs") {
      for (l = 0; l != n.length; ++l) ma(this, n.charCodeAt(l), this.l + 2 * l);
      i = 2 * n.length;
    } else if (s === "sbcs" || s == "cpstr") {
      if (typeof a !== "undefined" && t == 874) {
        ...
        i = n.length;
      } else if (typeof a !== "undefined" && s == "cpstr") {
  ...
  function va(e, r) {
    var t = Ut(this, this.l, e.length >> 1);
  ...
  function ka(e, r, t) {
    ...
    while (e.l < i) {
      ...
      a = e._R(1);
      s = a & 127;
      for (n = 1; n < 4 && a & 128; ++n) s += ((a = e._R(1)) & 127) << (7 * n);
      o = e.l + s;
      var f = c.f && c.f(e, s, t);
      e.l = o;
      if (r(f, c, l)) return;
  ...
  function ya() {
    ...
    return { next: s, push: l, end: i, _bufs: e };
  }
  function xa(e, r, t, a) {
    var n = +r,
      s;
  ...
  function _a(e, r) {
    ...
    var t = La(e);
    if (!e.cRel && e.cRel != null) t = Na(t);
    if (!e.rRel && e.rRel != null) t = Ta(t);
    return t;
  }
  function Aa(e, r) {
    if (e.s.r == 0 && !e.s.rRel) {
    ...
    return _a(e.s, r.biff) + ":" + _a(e.e, r.biff);
  }
  function Fa(e) {
  ...
  function za(e, r) {
    ...
    if (typeof e !== "string") e = La(e);
    if (typeof r !== "string") r = La(r);
    return e == r ? e : e + ":" + r;
  }
  function $a(e) {
    var r = Ba(e);
    return (
      "$" + Ma(r.s.c) + "$" + Ea(r.s.r) + ":$" + Ma(r.e.c) + "$" + Ea(r.e.r)
    );
  }
  function Wa(e, r) {
  ...
  function ja(e, r) {
    ...
    if (e.z != null)
      try {
        return (e.w = Ue(e.z, t ? hr(r) : r));
      } catch (a) {}
    try {
      return (e.w = Ue((e.XF || {}).numFmtId || (t ? 14 : 0), t ? hr(r) : r));
    } catch (a) {
      return "" + r;
    }
  }
      ...
      for (var p = 0; p != r[h].length; ++p) {
        ...
        if (
          ...
          if (v.v === null) {
            ...
            if (a.cellDates) {
              v.t = "d";
              v.w = Ue(v.z, hr(v.v, a.date1904));
            } else {
              v.t = "n";
              v.v = hr(v.v, a.date1904);
              v.w = Ue(v.z, v.v);
            }
          } else v.t = "s";
        }
        if (n) {
          if (u[b] && u[b].z) v.z = u[b].z;
          u[b] = v;
        } else {
          var w = Ma(b) + m;
          if (s[w] && s[w].z) v.z = s[w].z;
          s[w] = v;
        }
      }
    }
    if (c.s.c < 1e7) s["!ref"] = za(c);
    return s;
  }
  function Ga(e, r) {
    return Xa(null, e, r);
  ...
  var on = {
    1: { n: "CodePage", t: Ya },
    2: { n: "Category", t: nn },
    3: { n: "PresentationFormat", t: nn },
    4: { n: "ByteCount", t: Ja },
    5: { n: "LineCount", t: Ja },
    6: { n: "ParagraphCount", t: Ja },
    7: { n: "SlideCount", t: Ja },
    8: { n: "NoteCount", t: Ja },
    9: { n: "HiddenCount", t: Ja },
    10: { n: "MultimediaClipCount", t: Ja },
    11: { n: "ScaleCrop", t: Ka },
    12: { n: "HeadingPairs", t: tn },
    13: { n: "TitlesOfParts", t: an },
    14: { n: "Manager", t: nn },
    15: { n: "Company", t: nn },
    16: { n: "LinksUpToDate", t: Ka },
    17: { n: "CharacterCount", t: Ja },
    19: { n: "SharedDoc", t: Ka },
    22: { n: "HyperlinksChanged", t: Ka },
    23: { n: "AppVersion", t: Ja, p: "version" },
    24: { n: "DigSig", t: en },
    26: { n: "ContentType", t: nn },
    27: { n: "ContentStatus", t: nn },
    28: { n: "Language", t: nn },
    29: { n: "Version", t: nn },
    255: {},
    2147483648: { n: "Locale", t: qa },
    2147483651: { n: "Behavior", t: qa },
    1919054434: {},
  };
  var cn = {
    1: { n: "CodePage", t: Ya },
    ...
    16: { n: "CharCount", t: Ja },
    17: { n: "Thumbnail", t: rn },
    18: { n: "Application", t: nn },
    19: { n: "DocSecurity", t: Ja },
    255: {},
    2147483648: { n: "Locale", t: qa },
    2147483651: { n: "Behavior", t: qa },
    1919054434: {},
    ...
    (e.match(Yr) || []).forEach(function (e) {
      ...
      switch (a[0].replace(Jr, "<")) {
        ...
        case "<Default":
          ...
          break;
        case "<Override":
          if (r[bn[a.ContentType]] !== undefined)
            r[bn[a.ContentType]].push(a.PartName);
          break;
      }
    });
    if (r.xmlns !== Mt.CT) throw new Error("Unknown Namespace: " + r.xmlns);
    ...
    if (!t) {
      ...
      n = n.concat(
        [
          ...
          return Ft("Default", null, { Extension: e[0], ContentType: e[1] });
        })
      );
    }
    var i = function (t) {
      if (e[t] && e[t].length > 0) {
        s = e[t][0];
        n[n.length] = Ft("Override", null, {
          PartName: (s[0] == "/" ? "" : "/") + s,
          ContentType: wn[t][r.bookType] || wn[t]["xlsx"],
        });
      }
    };
    var l = function (t) {
  ...
  function _n(e, r) {
    ...
    (e.match(Yr) || []).forEach(function (e) {
      ...
      if (n[0] === "<Relationship") {
        ...
        s.Target = n.Target;
        s.Id = n.Id;
        if (n.TargetMode) s.TargetMode = n.TargetMode;
        var i = n.TargetMode === "External" ? n.Target : jr(n.Target, r);
        t[i] = s;
        a[n.Id] = s;
      }
    });
  ...
  function An(e) {
    var r = [Hr, Ft("Relationships", null, { xmlns: Mt.RELS })];
    ir(e["!id"]).forEach(function (t) {
      r[r.length] = Ft("Relationship", null, e["!id"][t]);
    });
    if (r.length > 2) {
  ...
  function Fn(e, r, t, a, n, s) {
    ...
    n.Target = t;
    if (s) n.TargetMode = s;
    else if ([Sn.HLINK, Sn.XPATH, Sn.XMISS].indexOf(n.Type) > -1)
  ...
  var En = "application/vnd.oasis.opendocument.spreadsheet";
  function Tn(e, r) {
    var t = Dt(e);
    var a;
    var n;
  ...
  function Nn(e) {
    ...
    for (var t = 0; t != e.length; ++t) {
      r.push(On(e[t][0], e[t][1]));
      r.push(Mn("", e[t][0]));
    }
    r.push(On("", "Document", "pkg"));
    r.push("</rdf:RDF>");
    return r.join("");
  }
  function Pn() {
  ...
  function Ln(e) {
    ...
    for (var t = 0; t < In.length; ++t) {
      ...
      if (a[2] === "date" && r[a[1]]) r[a[1]] = yr(r[a[1]]);
    }
    return r;
  }
  function Bn(e, r, t, a, n) {
    ...
    n[e] = r;
    r = nt(r);
    a[a.length] = t ? Ft(e, r, t) : _t(e, r);
  }
  function zn(e, r) {
    var t = r || {};
    var a = [
        Hr,
        Ft("cp:coreProperties", null, {
    ...
    for (var s = 0; s != In.length; ++s) {
      var i = In[s];
      var l =
        t.Props && t.Props[i[1]] != null ? t.Props[i[1]] : e ? e[i[1]] : null;
      if (l === true) l = "1";
      else if (l === false) l = "0";
      else if (typeof l == "number") l = String(l);
      if (l != null) Bn(i[0], l, null, a, n);
    }
    if (a.length > 2) {
      ...
      for (var c = 0; c !== n.length; c += 2) {
        ...
        switch (n[c].v) {
          ...
          case "Navngivne omrÃ¥der":
            t.NamedRanges = o;
            t.DefinedNames = i.slice(l, l + o);
            break;
          case "Charts":
          case "Diagramme":
            t.Chartsheets = o;
            t.ChartNames = i.slice(l, l + o);
            break;
        }
        l += o;
      }
  ...
  function jn(e, r, t) {
    ...
    if (a.HeadingPairs && a.TitlesOfParts)
      Un(a.HeadingPairs, a.TitlesOfParts, r, t);
    return r;
  }
  function Hn(e) {
    var r = [],
  ...
  function Gn(e) {
    var r = [
      Hr,
      Ft("Properties", null, { xmlns: Mt.CUST_PROPS, "xmlns:vt": Mt.vt }),
    ];
    if (!e) return r.join("");
    var t = 1;
    ir(e).forEach(function a(n) {
      ++t;
      r[r.length] = Ft("property", Tt(e[n], true), {
  ...
  var Yn = [2, 3, 48, 49, 131, 139, 140, 245];
  var Jn = (function () {
    var e = {
      1: 437,
      2: 850,
    ...
    function s(r, t) {
      ...
      var g = c ? 32 : 11;
      while (s.l < v && s[s.l] != 13) {
        p = {};
        p.name = (
          typeof a !== "undefined"
            ? a.utils.decode(d, s.slice(s.l, s.l + g))
            : D(s.slice(s.l, s.l + g))
        ).replace(/[\u0000\r\n].*$/g, "");
        s.l += g;
        p.type = String.fromCharCode(s._R(1));
        if (i != 2 && !c) p.offset = s._R(4);
        p.len = s._R(1);
        if (i == 2) p.offset = s._R(2);
        p.dec = s._R(1);
        if (p.name.length) m.push(p);
        if (i != 2) s.l += c ? 13 : 14;
        switch (p.type) {
          case "B":
            if ((!o || p.len != 8) && t.WTF)
      ...
      if (s[s.l] !== 13) s.l = u - 1;
      if (s._R(1) !== 13)
        throw new Error("DBF Terminator not found " + s.l + " " + s[s.l]);
      s.l = u;
      var b = 0,
        w = 0;
      n[0] = [];
      for (w = 0; w != m.length; ++w) n[0][w] = m[w].name;
      while (f-- > 0) {
        if (s[s.l] === 42) {
          s.l += h;
          continue;
        ...
        for (w = 0; w != m.length; ++w) {
          var k = s.slice(s.l, s.l + m[w].len);
          s.l += m[w].len;
          ga(k, 0);
          var y = typeof a !== "undefined" ? a.utils.decode(d, k) : D(k);
          switch (m[w].type) {
            case "C":
            ...
            case "P":
              ...
              break;
            case "0":
              if (m[w].name === "_NullFlags") break;
            default:
              throw new Error("DBF Unsupported data type " + m[w].type);
          }
        }
      }
      if (i != 2)
        if (s.l < s.length && s[s.l++] != 26)
          throw new Error(
    ...
    function f(s, i) {
      ...
      for (v = 0; v <= k.e.c - k.s.c; ++v) {
        ...
        for (g = 0; g < m.length; ++g) {
          if (m[g][v] != null) F.push(m[g][v]);
        }
        if (F.length == 0 || d[v] == null) {
          y[v] = "?";
          continue;
        }
        for (g = 0; g < F.length; ++g) {
          ...
          A = Math.max(
            A,
            (typeof a !== "undefined" && typeof F[g] == "string"
              ? a.utils.encode(t, F[g])
              : String(F[g])
            ).length
          );
          C = C && C != _ ? "C" : _;
        ...
        _ = ((p[v] || {}).DBF || {}).type;
        if (_ == "C") {
          if (p[v].DBF.len > A) A = p[v].DBF.len;
        }
        if (C == "B" && _ == "N") {
          C = "N";
          S[v] = p[v].DBF.dec;
      ...
      for (v = 0; v < m.length; ++v) {
        ...
        for (g = 0; g < d.length; ++g) {
          ...
          switch (y[g]) {
            ...
            case "N":
              var P = "0";
              if (typeof m[v][g] == "number") P = m[v][g].toFixed(S[g] || 0);
              if (P.length > x[g]) P = P.slice(0, x[g]);
              for (b = 0; b < x[g] - P.length; ++b) N._W(1, 32);
              N._W(1, P, "sbcs");
              break;
            case "D":
              if (!m[v][g]) N._W(8, "00000000", "sbcs");
              else {
                N._W(4, ("0000" + m[v][g].getFullYear()).slice(-4), "sbcs");
                N._W(2, ("00" + (m[v][g].getMonth() + 1)).slice(-2), "sbcs");
                N._W(2, ("00" + m[v][g].getDate()).slice(-2), "sbcs");
              }
              break;
            case "C":
              var I = N.l;
    ...
    return { to_workbook: l, to_sheet: i, from_sheet: f };
  })();
  var Kn = (function () {
    var e = {
      AA: "Ã€",
    ...
    function s(e, r) {
      switch (r.type) {
        ...
        case "binary":
          return i(e, r);
        case "buffer":
          return i(S && Buffer.isBuffer(e) ? e.toString("binary") : D(e), r);
        case "array":
          return i(xr(e), r);
      }
      throw new Error("Unrecognized type " + r.type);
    ...
    function i(e, s) {
            ...
            case "NN":
              {
                ...
                for (u = 1; u < S.length; ++u)
                  switch (S[u].charAt(0)) {
                    ...
                    case "E":
                      F.Ref =
                        ((s && s.sheet) || "Sheet1") + "!" + Ci(S[u].slice(1));
                      break;
                  }
                y.Workbook.Names.push(F);
              }
              break;
            case "C":
              var E = false,
                ...
                switch (S[u].charAt(0)) {
                  ...
                  case "K":
                    ...
                    if (_.charAt(0) === '"') {
                      ...
                      _ = _r(_);
                      I = "n";
                      if (m !== null && Le(m) && s.cellDates) {
                        _ = vr(y.Workbook.WBProps.date1904 ? _ + 1462 : _);
                        I = "d";
                      }
                    } else if (!isNaN(Tr(_).getDate())) {
                      _ = yr(_);
                      I = "d";
                      if (!s.cellDates) {
                        I = "n";
                        _ = hr(_, y.Workbook.WBProps.date1904);
                      }
                    }
                    if (
                      typeof a !== "undefined" &&
                      ...
                      _ = a.utils.decode(s.codepage, _);
                    E = true;
                    break;
                  case "E":
                    O = true;
                    P = Ci(S[u].slice(1), { r: l, c: c });
                    break;
                  case "S":
                    D = true;
                    break;
                  ...
                  case "C":
                    ...
                    break;
                  default:
                    if (s && s.WTF) throw new Error("SYLK bad record " + x);
                }
              if (E) {
                if (!h[l][c]) h[l][c] = { t: I, v: _ };
                else {
                  h[l][c].t = I;
                  h[l][c].v = _;
                }
                if (m) h[l][c].z = m;
                if (s.cellText !== false && m)
                  h[l][c].w = Ue(h[l][c].z, h[l][c].v, {
              ...
              if (D) {
                ...
                P = Fi(R[1], { r: l - M, c: c - N });
              }
              if (P) {
                if (!h[l][c]) h[l][c] = { t: "n", f: P };
                else h[l][c].f = P;
              }
              break;
            case "F":
      ...
      if (s && s.sheetRows) h = h.slice(0, s.sheetRows);
      return [h, p, y];
    }
    function l(e, r) {
      var t = s(e, r);
      var a = t[0],
        ...
        i = t[2];
      var l = Sr(r);
      l.date1904 = (((i || {}).Workbook || {}).WBProps || {}).date1904;
      var o = Ga(a, l);
    ...
    function f(e, r) {
      r.forEach(function (r, t) {
        ...
        if (r.hidden) a += "0";
          ...
          if (typeof r.width == "number" && !r.wpx) r.wpx = Ss(r.width);
          if (typeof r.wpx == "number" && !r.wch) r.wch = Cs(r.wpx);
    ...
    function h(e, r, t) {
      ...
      if (e["!cols"]) f(a, e["!cols"]);
      if (e["!rows"]) u(a, e["!rows"]);
      a.push(
        "B;Y" +
          (s.e.r - s.s.r + 1) +
          ";X" +
      ...
      a.push("O;L;D;B" + (h ? ";V4" : "") + ";K47;G100 0.001");
      for (var d = s.s.r; d <= s.e.r; ++d) {
        if (l && !e["!data"][d]) continue;
        var m = [];
        for (var p = s.s.c; p <= s.e.c; ++p) {
          i = l ? e["!data"][d][p] : e[Ma(p) + Ea(d)];
    ...
    return { to_workbook: l, from_sheet: h };
  })();
  var Zn = (function () {
    function e(e, t) {
      switch (t.type) {
        ...
        case "binary":
          return r(e, t);
        case "buffer":
          return r(S && Buffer.isBuffer(e) ? e.toString("binary") : D(e), t);
        case "array":
          return r(xr(e), t);
      }
    ...
    function r(e, r) {
      ...
      for (; s !== t.length; ++s) {
        ...
        if (a < 0) continue;
        var l = t[s].trim().split(",");
        var o = l[0],
          c = l[1];
        ++s;
        var f = t[s] || "";
        while ((f.match(/["]/g) || []).length & 1 && s < t.length - 1)
          f += "\n" + t[++s];
        f = f.trim();
        switch (+o) {
          case -1:
          ...
          case 0:
            ...
            else if (!isNaN(Tr(c).getDate())) i[a][n] = yr(c);
            else i[a][n] = c;
            ++n;
            break;
          case 1:
            ...
            f = f.replace(/""/g, '"');
            if (b && f && f.match(/^=".*"$/)) f = f.slice(2, -1);
            i[a][n++] = f !== "" ? f : null;
            break;
        }
        if (f === "EOD") break;
      }
      if (r && r.sheetRows) i = i.slice(0, r.sheetRows);
      return i;
    }
    function t(r, t) {
      return Ga(e(r, t), t);
        ...
        for (var f = t.s.c; f <= t.e.c; ++f) {
          ...
          switch (u.t) {
            ...
            case "s":
              ...
              break;
            case "d":
              if (!u.w) u.w = Ue(u.z || K[14], hr(yr(u.v)));
              if (r) c += n(u.w, "V");
              else c += s(u.w);
              break;
            default:
  ...
  var Qn = (function () {
    function e(e, r, t, a, n) {
      ...
      else if (!isNaN(Tr(e).getDate())) r[t][a] = yr(e);
      else r[t][a] = e;
    }
    function r(r, t) {
      var a = t || {};
      ...
      for (c = 0; c <= i; ++c) {
        n[c] = [];
        var f = 0;
        e(s[c].slice(0, l).trim(), n, c, f, a);
        for (f = 1; f <= (s[c].length - l) / 10 + 1; ++f)
          e(s[c].slice(l + (f - 1) * 10, l + f * 10).trim(), n, c, f, a);
      }
    ...
    function s(e) {
      var r = {},
        ...
        i = 0;
      for (; s < e.length; ++s) {
        if ((i = e.charCodeAt(s)) == 34) a = !a;
        else if (!a && i in t) r[i] = (r[i] || 0) + 1;
      }
      i = [];
      for (s in r)
    ...
    function i(e, r) {
      ...
      function b() {
        ...
        if (r.length === 0) a.t = "z";
          ...
          a.t = "b";
          a.v = false;
        } else if (!isNaN((c = _r(r)))) {
          a.t = "n";
          if (t.cellText !== false) a.w = r;
          a.v = c;
        } else if (!isNaN((c = Tr(r)).getDate()) || (v && r.match(v))) {
          a.z = t.dateNF || K[14];
          var s = 0;
          if (v && r.match(v)) {
            r = Ke(r, t.dateNF, r.match(v) || []);
            s = 1;
            c = yr(r, s);
          }
          if (t.cellDates) {
          ...
          if (t.cellText !== false)
            a.w = Ue(a.z, a.v instanceof Date ? hr(a.v) : a.v);
    ...
    function o(e, r) {
      var t = "",
        n = r.type == "string" ? [0, 0, 0, 0] : Mo(e, r);
      switch (r.type) {
        case "base64":
          t = x(e);
          break;
        ...
        case "buffer":
          ...
          else t = S && Buffer.isBuffer(e) ? e.toString("binary") : D(e);
          break;
        case "array":
          t = xr(e);
          break;
      ...
      if (t.slice(0, 19) == "socialcalc:version:")
        return qn.to_sheet(r.type == "string" ? t : vt(t), r);
      return l(t, r);
    }
    function c(e, r) {
      return Va(o(e, r), r);
  ...
  function es(e, r) {
    ...
    try {
      ...
      t.WTF = a;
      if (!s.message.match(/SYLK bad record ID/) && a) throw s;
      return Qn.to_workbook(e, r);
    }
  }
  function rs(e) {
    var r = {},
  ...
  function ls(e, r) {
    ...
    if (e.match(/^\s*<(?:\w+:)?t[^>]*>/)) {
      a.t = rt(
        vt(e.slice(e.indexOf(">") + 1).split(/<\/(?:\w+:)?t>/)[0] || ""),
        true
      );
      a.r = vt(e);
      if (t) a.h = lt(a.t);
      ...
      a.r = vt(e);
      a.t = rt(
        vt((e.replace(is, "").match(ns) || []).join("").replace(Yr, "")),
        true
      );
      if (t) a.h = as(ts(a.r));
    }
  ...
  function us(e, r) {
    ...
    var n = e.match(os);
    if (n) {
      a = n[2].replace(cs, "").split(fs);
      for (var s = 0; s != a.length; ++s) {
        var i = ls(a[s].trim(), r);
        if (i != null) t[t.length] = i;
      }
      n = Zr(n[1]);
      t.Count = n.count;
  ...
  function ds(e, r) {
    ...
    for (var a = 0; a != e.length; ++a) {
      ...
      if (n.r) s += n.r;
        ...
        if (n.t.match(hs)) s += ' xml:space="preserve"';
        s += ">" + nt(n.t) + "</t>";
      }
      s += "</si>";
      t[t.length] = s;
  ...
  function gs(e) {
    ...
    for (var c = 0; c != 3; ++c) i[c] = Math.round(i[c] * 255);
    return i;
  }
  function bs(e, r) {
    if (r === 0) return e;
  ...
  var ws = 6,
    ...
    xs = ws;
  function Ss(e) {
    return Math.floor((e + Math.round(128 / xs) / 256) * xs);
  }
  function Cs(e) {
    return Math.floor(((e - 5) / xs) * 100 + 0.5) / 100;
  }
  function _s(e) {
    return Math.round(((e * xs + 5) / xs) * 256) / 256;
  }
  function As(e) {
    return _s(Cs(Ss(e)));
  }
  function Fs(e) {
    var r = Math.abs(e - As(e)),
      t = xs;
    if (r > 0.005)
      for (xs = ys; xs < ks; ++xs)
        if (Math.abs(e - As(e)) <= r) {
          r = Math.abs(e - As(e));
          t = xs;
        }
    xs = t;
  ...
  function Ps(e, r, t, a) {
    ...
    (e[0].match(Yr) || []).forEach(function (e) {
      ...
      switch (qr(t[0])) {
        ...
        case "<border/>":
          n = {};
          if (t.diagonalUp) n.diagonalUp = ut(t.diagonalUp);
          if (t.diagonalDown) n.diagonalDown = ut(t.diagonalDown);
          r.Borders.push(n);
          break;
        case "</border>":
          break;
        ...
        default:
          if (a && a.WTF) {
            if (!s) throw new Error("unrecognized " + t[0] + " in borders");
          }
      }
    });
  }
  function Is(e, r, t, a) {
    ...
    (e[0].match(Yr) || []).forEach(function (e) {
      ...
      switch (qr(t[0])) {
        ...
        default:
          if (a && a.WTF) {
            if (!s) throw new Error("unrecognized " + t[0] + " in fills");
          }
      }
    });
  }
  function Rs(e, r, t, a) {
    ...
    (e[0].match(Yr) || []).forEach(function (e) {
      ...
      switch (qr(l[0])) {
        ...
        case "<charset":
          if (l.val == "1") break;
          l.codepage = s[parseInt(l.val, 10)];
          break;
        case "<color":
          if (!n.color) n.color = {};
          if (l.auto) n.color.auto = ut(l.auto);
          if (l.rgb) n.color.rgb = l.rgb.slice(-6);
          else if (l.indexed) {
            n.color.index = parseInt(l.indexed, 10);
            var o = mn[n.color.index];
            if (n.color.index == 81) o = mn[1];
            if (!o) o = mn[1];
            n.color.rgb =
        ...
        default:
          if (a && a.WTF) {
            if (!i) throw new Error("unrecognized " + l[0] + " in fonts");
          }
      }
    });
  }
  function Ls(e, r, t) {
    r.NumberFmt = [];
    var a = ir(K);
    for (var n = 0; n < a.length; ++n) r.NumberFmt[a[n]] = K[a[n]];
    var s = e[0].match(Yr);
    if (!s) return;
  ...
  function Bs(e) {
    ...
    r[r.length] = "</numFmts>";
    r[0] = Ft("numFmts", null, { count: r.length - 2 }).replace("/>", ">");
    return r.join("");
  }
  var zs = ["numFmtId", "fillId", "fontId", "borderId", "xfId"];
  var $s = [
    "applyAlignment",
    "applyBorder",
    "applyFill",
      ...
      switch (qr(s[0])) {
        ...
        case "<xf/>":
          ...
          for (i = 0; i < zs.length; ++i)
            if (a[zs[i]]) a[zs[i]] = parseInt(a[zs[i]], 10);
          for (i = 0; i < $s.length; ++i) if (a[$s[i]]) a[$s[i]] = ut(a[$s[i]]);
        ...
        case "<alignment/>":
          var l = {};
          if (s.vertical) l.vertical = s.vertical;
          if (s.horizontal) l.horizontal = s.horizontal;
          if (s.textRotation != null) l.textRotation = s.textRotation;
          if (s.indent) l.indent = s.indent;
          if (s.wrapText) l.wrapText = ut(s.wrapText);
          a.alignment = l;
          break;
        case "</alignment>":
          break;
        ...
        default:
          if (t && t.WTF) {
            if (!n) throw new Error("unrecognized " + s[0] + " in cellXfs");
          }
      }
    });
  }
  function Us(e) {
    var r = [];
    r[r.length] = Ft("cellXfs", null);
    e.forEach(function (e) {
      r[r.length] = Ft("xf", null, e);
    });
    r[r.length] = "</cellXfs>";
    if (r.length === 2) return "";
    r[0] = Ft("cellXfs", null, { count: r.length - 2 }).replace("/>", ">");
    return r.join("");
  }
  var js = (function Wc() {
    ...
    return function s(i, l, o) {
      ...
      i = i
        ...
        .replace(/<!DOCTYPE[^\[]*\[[^\]]*\]>/gm, "");
      var f;
      if ((f = i.match(e))) Ls(f, c, o);
      if ((f = i.match(a))) Rs(f, c, l, o);
      if ((f = i.match(t))) Is(f, c, l, o);
      if ((f = i.match(n))) Ps(f, c, l, o);
      if ((f = i.match(r))) Ws(f, c, o);
      return c;
    };
  })();
  function Hs(e, r) {
    var t = [Hr, Ft("styleSheet", null, { xmlns: Nt[0], "xmlns:vt": Mt.vt })],
      a;
    if (e.SSF && (a = Bs(e.SSF)) != null) t[t.length] = a;
    t[t.length] =
    ...
    if ((a = Us(r.cellXfs))) t[t.length] = a;
    t[t.length] =
  ...
  function Xs(e, r, t) {
    ...
    (e[0].match(Yr) || []).forEach(function (e) {
      ...
      switch (n[0]) {
        ...
        case "</a:folHlink>":
          if (n[0].charAt(1) === "/") {
            r.themeElements.clrScheme[Vs.indexOf(n[0])] = a;
            a = {};
          } else {
  ...
  function Gs() {}
  function Ys() {}
  var Js = /<a:clrScheme([^>]*)>[\s\S]*<\/a:clrScheme>/;
  ...
  var Qs = /<a:themeElements([^>]*)>[\s\S]*<\/a:themeElements>/;
  function ei(e, r) {
    if (!e || e.length === 0) e = ri();
    var t;
    var a = {};
    if (!(t = e.match(Qs))) throw new Error("themeElements not found in theme");
    qs(t[0], a, r);
    a.raw = e;
    return a;
  }
      ...
      switch (qr(r[0])) {
        ...
        case "<futureMetadata":
          for (var l = 0; l < a.Types.length; ++l)
            if (a.Types[l].name == r.name) i = a.Types[l];
          break;
        case "</futureMetadata>":
          break;
        case "<bk>":
  ...
  function li(e, r) {
    ...
    var n = [
      ...
      Ft("o:shapelayout", Ft("o:idmap", null, { "v:ext": "edit", data: e }), {
        "v:ext": "edit",
      }),
    ];
    var s = 65536 * e;
    ...
    if (i.length > 0)
      n.push(
        Ft(
          "v:shapetype",
          [
            Ft("v:stroke", null, { joinstyle: "miter" }),
            Ft("v:path", null, {
              gradientshapeok: "t",
              "o:connecttype": "rect",
            }),
  ...
  function oi(e, r) {
    ...
    var n =
      a.type == "gradient"
        ? Ft("o:fill", null, { type: "gradientUnscaled", "v:ext": "view" })
        : null;
    var s = Ft("v:fill", n, a);
    ...
    return [
      ...
      s,
      Ft("v:shadow", null, i),
      Ft("v:path", null, { "o:connecttype": "none" }),
  ...
  function ci(e, r, t, a) {
    ...
    r.forEach(function (r) {
      var i = Ra(r.ref);
      if (n) {
        if (!e["!data"][i.r]) e["!data"][i.r] = [];
        s = e["!data"][i.r][i.c];
      } else s = e[r.ref];
      if (!s) {
        s = { t: "z" };
        if (n) e["!data"][i.r][i.c] = s;
        else e[r.ref] = s;
        var l = Ua(e["!ref"] || "BDWGO1000001:A1");
        if (l.s.r > i.r) l.s.r = i.r;
        if (l.e.r < i.r) l.e.r = i.r;
        if (l.s.c > i.c) l.s.c = i.c;
        if (l.e.c < i.c) l.e.c = i.c;
        var o = za(l);
        e["!ref"] = o;
      }
      if (!s.c) s.c = [];
      ...
      if (r.h) c.h = r.h;
      for (var f = s.c.length - 1; f >= 0; --f) {
        if (!t && s.c[f].T) return;
        if (t && !s.c[f].T) s.c.splice(f, 1);
      }
      if (t && a)
  ...
  function fi(e, r) {
    ...
    if (s && s[1])
      s[1].split(/<\/\w*:?comment>/).forEach(function (e) {
        ...
        if (c.r == "<t></t>") c.t = c.h = "";
        i.t = (c.t || "").replace(/\r\n/g, "\n").replace(/\r/g, "\n");
        if (r.cellHTML) i.h = c.h;
        a.push(i);
      });
    return a;
  }
  function ui(e) {
    var r = [Hr, Ft("comments", null, { xmlns: Nt[0] })];
    var t = [];
    r.push("<authors>");
    e.forEach(function (e) {
  ...
  function di(e, r, t) {
    var a = [
      Hr,
      Ft("ThreadedComments", null, { xmlns: Mt.TCMNT }).replace(/[\/]>/, ">"),
    ];
    e.forEach(function (e) {
      var n = "";
      (e[1] || []).forEach(function (s, i) {
        if (!s.T) {
          delete s.ID;
          return;
        }
        if (s.a && r.indexOf(s.a) == -1) r.push(s.a);
        var l = {
          ref: e[0],
          id:
        ...
        if (s.a)
          l.personId =
            ...
            "}";
        a.push(Ft("threadedComment", _t("text", s.t || ""), l));
      });
    });
  ...
  function pi(e) {
    var r = [
      Hr,
      Ft("personList", null, { xmlns: Mt.TCMNT, "xmlns:x": Nt[0] }).replace(
        /[\/]>/,
        ">"
      ),
    ];
  ...
  var vi = "application/vnd.ms-office.vbaProject";
  function gi(e) {
  ...
  var wi = ["xlsb", "xlsm", "xlam", "biff8", "xla"];
  function ki() {
    return { "!type": "dialog" };
  }
  function yi() {
  ...
  var Ai = (function () {
    return function e(r, t) {
      return r.replace(_i, function (e, r, a, n, s, i) {
        var l = Oa(n) - (a ? 0 : t.c);
        var o = Fa(i) - (s ? 0 : t.r);
        var c = s == "$" ? o + 1 : o == 0 ? "" : "[" + o + "]";
        var f = a == "$" ? l + 1 : l == 0 ? "" : "[" + l + "]";
  ...
  function Fi(e, r) {
    return e.replace(_i, function (e, t, a, n, s, i) {
      return (
        t +
        (a == "$" ? a + n : Ma(Oa(n) + r.c)) +
        (s == "$" ? s + i : Ea(Fa(i) + r.r))
  ...
  function Mi(e) {
    var r = "of:=" + e.replace(_i, "$1[.$2$3$4$5]").replace(/\]:\[/g, ":");
  ...
  function Ui(e, r, t, a, n, s) {
    ...
    if (e.t === "d" && typeof e.v === "string") e.v = yr(e.v);
    if ((!a || a.cellText !== false) && e.t !== "z")
      try {
        if (K[r] == null) qe(Ge[r] || "General", r);
        if (e.t === "e") e.w = e.w || pn[e.v];
        else if (r === 0) {
          if (e.t === "n") {
        ...
        } else if (e.t === "d") e.w = Ue(r, hr(e.v), Ri);
        else e.w = Ue(r, e.v, Ri);
      } catch (i) {
        if (a.WTF) throw i;
      }
  ...
  var Vi = /<(?:\w:)?mergeCell ref="[A-Z0-9:]+"\s*[\/]?>/g;
  ...
  function rl(e, r, t, a, n, s, i) {
    ...
    var h = c.match(qi);
    if (h) al(h[0], l, n, t);
    else if ((h = c.match(Qi))) nl(h[0], h[1] || "", l, n, t, i, s);
    var d = (c.match(/<(?:\w*:)?dimension/) || { index: -1 }).index;
    if (d > 0) {
      var m = c.slice(d, d + 50).match(Yi);
      if (m) Hi(l, m[1]);
    }
    var p = c.match(el);
    if (p && p[1]) gl(p[1], n);
    ...
    if (u) kl(u[1], l, r, o, s, i);
    var w = f.match(Ki);
    if (w) l["!autofilter"] = ml(w[0]);
    var k = [];
    var y = f.match(Vi);
    if (y)
      for (d = 0; d != y.length; ++d)
        k[d] = Ua(y[d].slice(y[d].indexOf('"') + 1));
    var x = f.match(Gi);
    if (x) cl(l, x, a);
    var S = f.match(Zi);
    if (S) l["!margins"] = fl(Zr(S[0]));
    if (!l["!ref"] && o.e.c >= o.s.c && o.e.r >= o.s.r) l["!ref"] = za(o);
  ...
  function tl(e) {
    ...
    for (var t = 0; t != e.length; ++t)
      r += '<mergeCell ref="' + za(e[t]) + '"/>';
    return r + "</mergeCells>";
  }
  function al(e, r, t, a) {
    var n = Zr(e);
    if (!t.Sheets[a]) t.Sheets[a] = {};
    if (n.codeName) t.Sheets[a].CodeName = rt(vt(n.codeName));
  }
  function nl(e, r, t, a, n) {
    al(e.slice(0, e.indexOf(">")), t, a, n);
  }
  function sl(e, r, t, a, n) {
    ...
    if (e && e["!outline"]) {
      ...
      l = (l || "") + Ft("outlinePr", null, f);
    }
    if (!s && !l) return;
    n[n.length] = Ft("sheetPr", l, i);
  }
  var il = ["objects", "scenarios", "selectLockedCells", "selectUnlockedCells"];
  var ll = [
    "formatColumns",
    "formatRows",
    "formatCells",
  ...
  function ol(e) {
    ...
    if (e.password)
      r.password = crypto_CreatePasswordVerifier_Method1(e.password)
        .toString(16)
        .toUpperCase();
    return Ft("sheetProtection", null, r);
  }
  function cl(e, r, t) {
    var a = e["!data"] != null;
    for (var n = 0; n != r.length; ++n) {
      var s = Zr(vt(r[n]), true);
      if (!s.ref) return;
      var i = ((t || {})["!id"] || [])[s.id];
      if (i) {
        s.Target = i.Target;
        if (s.location) s.Target += "#" + rt(s.location);
      } else {
        s.Target = "#" + rt(s.location);
  ...
  function ul(e) {
    $i(e);
    return Ft("pageMargins", null, e);
  }
  function hl(e, r) {
    var t = false;
    for (var a = 0; a != r.length; ++a) {
      var n = Zr(r[a], true);
      if (n.hidden) n.hidden = ut(n.hidden);
  ...
  function pl(e, r, t, a) {
    var n = typeof e.ref == "string" ? e.ref : za(e.ref);
    ...
    return Ft("autoFilter", null, { ref: n });
  }
  var vl = /<(?:\w:)?sheetView(?:[^>a-z][^>]*)?\/?>/g;
  function gl(e, r) {
    if (!r.Views) r.Views = [{}];
    (e.match(vl) || []).forEach(function (e, t) {
      var a = Zr(e);
      if (!r.Views[t]) r.Views[t] = {};
      if (+a.zoomScale) r.Views[t].zoom = +a.zoomScale;
      if (a.rightToLeft && ut(a.rightToLeft)) r.Views[t].RTL = true;
    });
  }
  function bl(e, r, t, a) {
    ...
    return Ft("sheetViews", Ft("sheetView", null, n), {});
  }
  function wl(e, r, t, a) {
    ...
    if (e.t !== "z")
      switch (e.t) {
        ...
        case "d":
          ...
          if (typeof e.z === "undefined") e.z = K[14];
          break;
        default:
          n = e.v;
          break;
      }
    var l = e.t == "z" || e.v == null ? "" : _t("v", nt(n)),
      o = { r: r };
    ...
    switch (e.t) {
      ...
      default:
        ...
        if (a && a.bookSST) {
          l = _t("v", "" + Bi(a.Strings, e.v, a.revStrings));
          o.t = "s";
          break;
        } else o.t = "str";
        break;
  ...
  var kl = (function () {
    ...
    return function l(o, c, f, u, h, d) {
      ...
      var I = [],
        ...
        L = false;
      var B = !!f.sheetStubs;
      for (var z = o.split(r), $ = 0, W = z.length; $ != W; ++$) {
        p = z[$].trim();
        var U = p.length;
        if (U === 0) continue;
        var j = 0;
        ...
        for (m = 0; m != v.length; ++m) {
          ...
          ++w;
          S = Zr(p.slice(0, w), true);
          if (!S.r) S.r = La({ r: C - 1, c: _ });
          y = p.slice(w);
          x = { t: "" };
          if ((g = y.match(s)) != null && g[1] !== "") x.v = rt(g[1]);
          if (f.cellFormula) {
            if ((g = y.match(i)) != null && g[1] !== "") {
              x.f = rt(vt(g[1]), true);
              if (!f.xlfn) x.f = Di(x.f);
              if (g[0].indexOf('t="array"') > -1) {
                x.F = (y.match(n) || [])[1];
                if (x.F.indexOf(":") > -1) M.push([Ua(x.F), x.F]);
              } else if (g[0].indexOf('t="shared"') > -1) {
                F = Zr(g[0]);
                var V = rt(vt(g[1]));
                if (!f.xlfn) V = Di(V);
                N[parseInt(F.si, 10)] = [F, V, S.r];
              }
            } else if ((g = y.match(/<f[^>]*\/>/))) {
              F = Zr(g[0]);
              if (N[F.si]) x.f = Ei(N[F.si][1], N[F.si][2], S.r);
            }
            var X = Ra(S.r);
            for (w = 0; w < M.length; ++w)
              if (X.r >= M[w][0].s.r && X.r <= M[w][0].e.r)
                if (X.c >= M[w][0].s.c && X.c <= M[w][0].e.c) x.F = M[w][1];
          }
          ...
          switch (x.t) {
            ...
            case "str":
              x.t = "s";
              x.v = x.v != null ? rt(vt(x.v), true) : "";
              if (f.cellHTML) x.h = lt(x.v);
              break;
            case "inlineStr":
              g = y.match(a);
              x.t = "s";
          ...
          if (D && S.s !== undefined) {
            ...
            if (O != null) {
              ...
              if (f.cellStyles) {
                if (O.fillId != null) T = O.fillId;
              }
            }
          }
          Ui(x, E, T, f, h, d);
          if (f.cellDates && D && x.t == "n" && Le(K[E])) {
            x.t = "d";
            x.v = vr(x.v);
          }
          if (S.cm && f.xlmeta) {
            var G = (f.xlmeta.Cell || [])[+S.cm - 1];
            if (G && G.type == "XLDAPR") x.D = true;
          }
          if (P) {
            var Y = Ra(S.r);
            if (!c["!data"][Y.r]) c["!data"][Y.r] = [];
            c["!data"][Y.r][Y.c] = x;
          } else c[S.r] = x;
        }
      }
  ...
  function yl(e, r, t, a) {
    ...
    var p = { r: c },
      v,
      g = -1;
    for (h = i.s.c; h <= i.e.c; ++h) f[h] = Ma(h);
    for (u = i.s.r; u <= i.e.r; ++u) {
      s = [];
      c = Ea(u);
      for (h = i.s.c; h <= i.e.c; ++h) {
        o = f[h] + c;
        var b = m ? (e["!data"][u] || [])[h] : e[o];
        if (b === undefined) continue;
        if ((l = wl(b, o, e, r, t, a)) != null) s.push(l);
      }
      if (s.length > 0 || (d && d[u])) {
        p = { r: c };
        if (d && d[u]) {
          v = d[u];
          if (v.hidden) p.hidden = 1;
          g = -1;
          if (v.hpx) g = Os(v.hpx);
          ...
          if (v.level) {
            p.outlineLevel = v.level;
          }
        }
        n[n.length] = Ft("row", s.join(""), p);
      }
    }
    if (d)
      for (; u < d.length; ++u) {
  ...
  function xl(e, r, t, a) {
    var n = [Hr, Ft("worksheet", null, { xmlns: Nt[0], "xmlns:r": Mt.r })];
    ...
    var u = [];
    sl(o, t, e, r, n);
    n[n.length] = Ft("dimension", null, { ref: c });
    n[n.length] = bl(o, r, e, t);
    if (r.sheetFormat)
      n[n.length] = Ft("sheetFormatPr", null, {
    ...
    if (o["!protect"]) n[n.length] = ol(o["!protect"]);
    if (o["!autofilter"] != null) n[n.length] = pl(o["!autofilter"], o, t, e);
    if (o["!merges"] != null && o["!merges"].length > 0)
      n[n.length] = tl(o["!merges"]);
    var h = -1,
      d,
      m = -1;
    if (o["!links"].length > 0) {
      ...
      o["!links"].forEach(function (e) {
        ...
        if (e[1].Target.charAt(0) != "#") {
          m = Fn(a, -1, nt(e[1].Target).replace(/#.*$/, ""), Sn.HLINK);
          d["r:id"] = "rId" + m;
        }
        if ((h = e[1].Target.indexOf("#")) > -1)
          d.location = nt(e[1].Target.slice(h + 1));
        if (e[1].Tooltip) d.tooltip = nt(e[1].Tooltip);
        d.display = e[1].display;
        n[n.length] = Ft("hyperlink", null, d);
      });
      n[n.length] = "</hyperlinks>";
    }
    delete o["!links"];
    if (o["!margins"] != null) n[n.length] = ul(o["!margins"]);
    if (!r || r.ignoreEC || r.ignoreEC == void 0)
      n[n.length] = _t(
        "ignoredErrors",
        Ft("ignoredError", null, { numberStoredAsText: 1, sqref: c })
      );
    if (u.length > 0) {
      m = Fn(a, -1, "../drawings/drawing" + (e + 1) + ".xml", Sn.DRAW);
      n[n.length] = Ft("drawing", null, { "r:id": "rId" + m });
      o["!drawing"] = u;
    }
    if (o["!comments"].length > 0) {
      m = Fn(a, -1, "../drawings/vmlDrawing" + (e + 1) + ".vml", Sn.VML);
      n[n.length] = Ft("legacyDrawing", null, { "r:id": "rId" + m });
      o["!legacy"] = m;
    }
    if (n.length > 1) {
    ...
    (e.match(/<c:numCache>[\s\S]*?<\/c:numCache>/gm) || []).forEach(function (
      ...
      r[0].forEach(function (e, t) {
        if (i["!data"]) {
          ...
          i["!data"][t][l] = { t: "n", v: e, z: r[1] };
        } else i[c + Ea(t)] = { t: "n", v: e, z: r[1] };
        o = t;
      });
      if (f.e.r < o) f.e.r = o;
      ++l;
  ...
  function _l(e, r, t, a, n) {
    ...
    var l = e.match(qi);
    if (l) al(l[0], s, n, t);
    if ((i = e.match(/drawing r:id="(.*?)"/))) s["!rel"] = i[1];
    if (a["!id"][s["!rel"]]) s["!drawel"] = a["!id"][s["!rel"]];
    return s;
  }
  var Al = [
  ...
  function Ml(e) {
    ...
    Dl(e.WBView, Fl);
    Dl(e.Sheets, El);
    Ri.date1904 = ut(e.WBProps.date1904);
  }
  function Nl(e) {
    if (!e.Workbook) return "false";
    if (!e.Workbook.WBProps) return "false";
    return ut(e.Workbook.WBProps.date1904) ? "true" : "false";
  }
  var Pl = ":][*?/\\".split("");
  function Il(e, r) {
    if (e.length > 31) {
  ...
  function Ll(e) {
    ...
    Rl(e.SheetNames, r, !!e.vbaraw);
    for (var t = 0; t < e.SheetNames.length; ++t)
      ji(e.Sheets[e.SheetNames[t]], e.SheetNames[t], t);
  ...
  function zl(e, r) {
    ...
    var s = {},
      i = 0;
    e.replace(Yr, function l(o, c) {
      var f = Zr(o);
      switch (qr(f[0])) {
        case "<?xml":
          break;
        case "<workbook":
          if (o.match(Bl)) n = "xmlns" + o.match(/<(\w+):/)[1];
          t.xmlns = f[n];
          break;
        case "</workbook>":
          break;
        ...
        case "<workbookPr/>":
          ...
          if (f.codeName) t.WBProps.CodeName = vt(f.codeName);
          break;
        case "</workbookPr>":
          break;
        ...
        case "<definedName":
          {
            ...
            if (f.localSheetId) s.Sheet = +f.localSheetId;
            if (ut(f.hidden || "0")) s.Hidden = true;
            i = c + o.length;
          }
          break;
        case "</definedName>":
          {
            s.Ref = rt(vt(e.slice(i, c)));
            t.Names.push(s);
          }
          break;
        case "<definedName/>":
  ...
  function $l(e) {
    var r = [Hr];
    r[r.length] = Ft("workbook", null, { xmlns: Nt[0], "xmlns:r": Mt.r });
    ...
    r[r.length] = Ft("workbookPr", null, a);
    ...
    r[r.length] = "<sheets>";
    for (s = 0; s != e.SheetNames.length; ++s) {
      var i = { name: nt(e.SheetNames[s].slice(0, 31)) };
      i.sheetId = "" + (s + 1);
      i["r:id"] = "rId" + (s + 1);
      if (n[s])
        switch (n[s].Hidden) {
    ...
    if (t) {
      ...
      if (e.Workbook && e.Workbook.Names)
        e.Workbook.Names.forEach(function (e) {
          ...
          if (!e.Ref) return;
          r[r.length] = Ft("definedName", nt(e.Ref), t);
        });
      r[r.length] = "</definedNames>";
    }
    if (r.length > 2) {
  ...
  function Ul(e, r, t, a, n, s, i, l) {
    if (r.slice(-4) === ".bin") return parse_ws_bin(e, a, t, n, s, i, l);
    return rl(e, a, t, n, s, i, l);
  }
  function jl(e, r, t, a, n, s, i, l) {
    if (r.slice(-4) === ".bin") return parse_cs_bin(e, a, t, n, s, i, l);
    return _l(e, a, t, n, s, i, l);
  }
  function Hl(e, r, t, a, n, s, i, l) {
    if (r.slice(-4) === ".bin") return xi(e, a, t, n, s, i, l);
    return Si(e, a, t, n, s, i, l);
  }
  function Vl(e, r, t, a, n, s, i, l) {
    if (r.slice(-4) === ".bin") return ki(e, a, t, n, s, i, l);
    return yi(e, a, t, n, s, i, l);
  }
  function Xl(e, r, t, a) {
  ...
  function Kl(e, r, t, a) {
    if (t.slice(-4) === ".bin") return si(e, r, t, a);
    return ni(e, r, t, a);
  }
  function Zl(e, r, t) {
  ...
  function ql(e, r) {
    ...
    for (l = 0; l < c.length; ++l) {
      ...
      for (o = 0; o < w.length; ++o) {
        ...
        } else if (y === "TRUE") F = { t: "b", v: true };
        else if (y === "FALSE") F = { t: "b", v: false };
        else if (!isNaN(_r(y))) F = { t: "n", v: _r(y) };
        else if (!isNaN(Tr(y).getDate())) {
          F = { t: "d", v: yr(y) };
          if (!t.cellDates) F = { t: "n", v: hr(F.v) };
          F.z = t.dateNF || K[14];
        }
        if (a) {
  ...
  function Ql(e, r, t, a) {
    ...
    for (var o = r.s.c; o <= r.e.c; ++o) {
      ...
      var m =
        (d && d.v != null && (d.h || lt(d.w || (Ha(d), d.w) || ""))) || "";
      i = {};
      if (c > 1) i.rowspan = c;
      if (f > 1) i.colspan = f;
      if (a.editable) m = '<span contenteditable="true">' + m + "</span>";
      else if (d) {
        i["data-t"] = (d && d.t) || "z";
        if (d.v != null) i["data-v"] = d.v;
        if (d.z != null) i["data-z"] = d.z;
        if (d.l && (d.l.Target || "#").charAt(0) != "#")
          m = '<a href="' + d.l.Target + '">' + m + "</a>";
      }
      i.id = (a.id || "sjs") + "-" + h;
      s.push(Ft("td", m, i));
    }
  ...
  function no(e, r) {
    ...
    var i = Ba(e["!ref"]);
    s.push(ao(e, i, t));
    for (var l = i.s.r; l <= i.e.r; ++l) s.push(Ql(e, i, l, t));
    s.push("</table>" + n);
    return s.join("");
  }
  function so(e, r, t) {
    ...
    if (n.origin != null) {
      if (typeof n.origin == "number") i = n.origin;
        ...
        var o = typeof n.origin == "string" ? Ra(n.origin) : n.origin;
        i = o.r;
        l = o.c;
      }
    }
    ...
    for (; p < a.length && v < c; ++p) {
      ...
      for (g = b = 0; g < x.length; ++g) {
        ...
        for (d = 0; d < h.length; ++d) {
          var A = h[d];
          if (A.s.c == b + l && A.s.r < v + i && v + i <= A.e.r) {
            b = A.e.c + 1 - l;
            d = -1;
          }
        }
        ...
        if ((w = +S.getAttribute("rowspan") || 1) > 1 || k > 1)
          h.push({
            s: { r: v + i, c: b + l },
            e: { r: v + i + (w || 1) - 1, c: b + l + (k || 1) - 1 },
          });
        var F = { t: "s", v: C };
        var E = S.getAttribute("data-t") || S.getAttribute("t") || "";
        if (C != null) {
          if (C.length == 0) F.t = E || "z";
          else if (n.raw || C.trim().length == 0 || E == "s") {
          } else if (C === "TRUE") F = { t: "b", v: true };
          else if (C === "FALSE") F = { t: "b", v: false };
          else if (!isNaN(_r(C))) F = { t: "n", v: _r(C) };
          else if (!isNaN(Tr(C).getDate())) {
            F = { t: "d", v: yr(C) };
            if (!n.cellDates) F = { t: "n", v: hr(F.v) };
            F.z = n.dateNF || K[14];
          }
        }
        if (F.z === undefined && _ != null) F.z = _;
        var T = "",
          D = S.getElementsByTagName("A");
        if (D && D.length)
          for (var O = 0; O < D.length; ++O)
            if (D[O].hasAttribute("href")) {
              T = D[O].getAttribute("href");
              if (T.charAt(0) != "#") break;
            }
        if (
          T &&
          T.charAt(0) != "#" &&
          T.slice(0, 11).toLowerCase() != "javascript:"
        )
          F.l = { Target: T };
        if (s) {
          if (!e["!data"][v + i]) e["!data"][v + i] = [];
          e["!data"][v + i][b + l] = F;
        } else e[La({ c: b + l, r: v + i })] = F;
    ...
    f.e.r = Math.max(f.e.r, v - 1 + i);
    e["!ref"] = za(f);
    if (v >= c) e["!fullref"] = za(((f.e.r = a.length - p + v - 1 + i), f));
    return e;
  }
  function io(e, r) {
    var t = r || {};
    ...
    while ((s = Ot.exec(n))) {
      switch ((s[3] = s[3].replace(/_.*$/, ""))) {
        ...
        case "text-style":
          if (s[1] === "/") {
            h = false;
            if (i["truncate-on-overflow"] == "false") {
        ...
        case "text":
          if (s[1] === "/") {
            d = n.slice(u, Ot.lastIndex - s[0].length);
            if (d == "%" && i[0] == "<number:percentage-style") l += "%";
            else l += '"' + d.replace(/"/g, '""') + '"';
          } else if (s[0].charAt(s[0].length - 2) !== "/") {
            u = Ot.lastIndex;
          }
        ...
        case "seconds":
          {
            ...
            if (c["decimal-places"]) l += "." + Cr("0", +c["decimal-places"]);
          }
          break;
        case "year":
          {
        ...
        case "scientific-number":
          ...
          l +=
            "0." +
            Cr("0", +c["min-decimal-places"] || +c["decimal-places"] || 2) +
            Cr("?", +c["decimal-places"] - +c["min-decimal-places"] || 0) +
            "E" +
            (ut(c["forced-exponent-sign"]) ? "+" : "") +
            Cr("0", +c["min-exponent-digits"] || 2);
          break;
        case "fraction":
          c = Zr(s[0], false);
          if (!+c["min-integer-digits"]) l += "#";
          else l += Cr("0", +c["min-integer-digits"]);
          l += " ";
          l += Cr("?", +c["min-numerator-digits"] || 1);
          l += "/";
          if (+c["denominator-value"]) l += c["denominator-value"];
          else l += Cr("?", +c["min-denominator-digits"] || 1);
          break;
        case "currency-symbol":
          if (s[1] === "/") {
            l +=
              '"' +
              n.slice(u, Ot.lastIndex - s[0].length).replace(/"/g, '""') +
              '"';
          } else if (s[0].charAt(s[0].length - 2) !== "/") {
            u = Ot.lastIndex;
          } else l += "$";
        ...
        case "number":
          ...
          c = Zr(s[0], false);
          o = "";
          o += Cr("0", +c["min-integer-digits"] || 1);
          if (ut(c["grouping"])) o = de(Cr("#", Math.max(0, 4 - o.length)) + o);
          if (+c["min-decimal-places"] || +c["decimal-places"]) o += ".";
          if (+c["min-decimal-places"])
            o += Cr("0", +c["min-decimal-places"] || 1);
  ...
  function ho(e, r, t) {
    ...
    while ((v = Ot.exec(n)))
      switch ((v[3] = v[3].replace(/_.*$/, ""))) {
        ...
        case "å·¥ä½œè¡¨":
          if (v[1] === "/") {
            if (A.e.c >= A.s.c && A.e.r >= A.s.r) p["!ref"] = za(A);
            else p["!ref"] = "A1:A1";
            if (a.sheetRows > 0 && a.sheetRows <= A.e.r) {
              p["!fullref"] = p["!ref"];
              A.e.r = a.sheetRows - 1;
              p["!ref"] = za(A);
            }
            if (D.length) p["!merges"] = D;
            if (P.length) p["!rows"] = P;
            u.name = u["åç§°"] || u.name;
        ...
        case "è¡Œ":
          ...
          h = Zr(v[0], false);
          if (h["è¡Œå·"]) C = h["è¡Œå·"] - 1;
          else if (C == -1) C = 0;
          I = +h["number-rows-repeated"] || 1;
          if (I < 10)
            for (G = 0; G < I; ++G) if (F > 0) P[C + G] = { level: F };
          _ = -1;
          break;
        case "covered-table-cell":
          ...
          if (a.sheetStubs) {
            if (a.dense) {
              if (!p["!data"][C]) p["!data"][C] = [];
              p["!data"][C][_] = { t: "z" };
            } else p[La({ r: C, c: _ })] = { t: "z" };
          }
          k = "";
          S = [];
          break;
        ...
        case "æ•°æ®":
          if (v[0].charAt(v[0].length - 2) === "/") {
            ++_;
            w = Zr(v[0], false);
            R = parseInt(w["number-columns-repeated"] || "1", 10);
            b = { t: "z", v: null };
            if (w.formula && a.cellFormula != false) b.f = Oi(rt(w.formula));
            if (w["style-name"] && T[w["style-name"]]) b.z = T[w["style-name"]];
            ...
            W = [];
            U = {};
            b = { t: w["æ•°æ®ç±»åž‹"] || w["value-type"], v: null };
            if (w["style-name"] && T[w["style-name"]]) b.z = T[w["style-name"]];
            if (a.cellFormula) {
              ...
              if (
                ...
                M = parseInt(w["number-matrix-rows-spanned"], 10) || 0;
                N = parseInt(w["number-matrix-columns-spanned"], 10) || 0;
                O = { s: { r: C, c: _ }, e: { r: C + M - 1, c: _ + N - 1 } };
                b.F = za(O);
                L.push([O, b.F]);
              }
              if (w.formula) b.f = Oi(w.formula);
              else
                for (G = 0; G < L.length; ++G)
                  if (C >= L[G][0].s.r && C <= L[G][0].e.r)
                    if (_ >= L[G][0].s.c && _ <= L[G][0].e.c) b.F = L[G][1];
            }
            if (w["number-columns-spanned"] || w["number-rows-spanned"]) {
              M = parseInt(w["number-rows-spanned"], 10) || 0;
              N = parseInt(w["number-columns-spanned"], 10) || 0;
              O = { s: { r: C, c: _ }, e: { r: C + M - 1, c: _ + N - 1 } };
              D.push(O);
            }
            if (w["number-columns-repeated"])
              R = parseInt(w["number-columns-repeated"], 10);
            switch (b.t) {
              case "boolean":
                b.t = "b";
                b.v = ut(w["boolean-value"]) || +w["boolean-value"] >= 1;
                break;
              case "float":
                b.t = "n";
              ...
              case "date":
                ...
                if (!a.cellDates) {
                  b.t = "n";
                  b.v = hr(b.v, B.WBProps.date1904) - Y;
                }
                if (!b.z) b.z = "m/d/yy";
                break;
              case "time":
            ...
            if (!V || a.sheetStubs) {
              if (!(a.sheetRows && a.sheetRows <= C)) {
                for (var K = 0; K < I; ++K) {
                  R = parseInt(w["number-columns-repeated"] || "1", 10);
                  if (a.dense) {
                    if (!p["!data"][C + K]) p["!data"][C + K] = [];
                    p["!data"][C + K][_] = K == 0 ? b : Sr(b);
                    while (--R > 0) p["!data"][C + K][_ + R] = Sr(b);
                  } else {
                    p[La({ r: C + K, c: _ })] = b;
                    while (--R > 0) p[La({ r: C + K, c: _ + R })] = Sr(b);
                  }
                  if (A.e.c <= _) A.e.c = _;
                }
              }
        ...
        case "master-styles":
          if (v[1] === "/") {
            if ((i = s.pop())[0] !== v[3]) throw "Bad state: " + i;
          } else if (v[0].charAt(v[0].length - 2) !== "/") s.push([v[3], true]);
          break;
        case "annotation":
          if (v[1] === "/") {
            if ((i = s.pop())[0] !== v[3]) throw "Bad state: " + i;
        ...
        case "time-style":
          if (v[1] === "/") {
            var Z = Ot.lastIndex;
            uo(n.slice(o, Ot.lastIndex), r, E);
            Ot.lastIndex = Z;
          } else if (v[0].charAt(v[0].length - 2) !== "/") {
            o = Ot.lastIndex - v[0].length;
          }
          break;
        case "script":
          break;
        ...
        case "style":
          {
            var q = Zr(v[0], false);
            if (q["family"] == "table-cell" && E[q["data-style-name"]])
              T[q["name"]] = E[q["data-style-name"]];
          }
          break;
        case "map":
          break;
        ...
        case "named-range":
          l = Zr(v[0], false);
          $ = Ni(l["cell-range-address"]);
          var Q = { Name: l.name, Ref: $[0] + "!" + $[1] };
          if (X) Q.Sheet = m.length;
          B.Names.push(Q);
          break;
        case "text-content":
          break;
        ...
        case "database-range":
          if (v[1] === "/") break;
          try {
            $ = Ni(Zr(v[0])["target-range-address"]);
            d[$[0]]["!autofilter"] = { ref: $[1] };
          } catch (re) {}
          break;
        case "date":
          break;
        ...
        case "a":
          if (v[1] !== "/") {
            ...
            if (z.Target.charAt(0) == "#" && z.Target.indexOf(".") > -1) {
              $ = Ni(z.Target.slice(1));
              z.Target = "#" + $[0] + "!" + $[1];
            } else if (z.Target.match(/^\.\.[\\\/]/))
              z.Target = z.Target.slice(3);
          }
          break;
    ...
    var te = { Sheets: d, SheetNames: m, Workbook: B };
    if (a.bookSheets) delete te.Sheets;
    return te;
  }
  function mo(e, r) {
    r = r || {};
    if (Pr(e, "META-INF/manifest.xml")) Tn(Rr(e, "META-INF/manifest.xml"), r);
    var t = Lr(e, "styles.xml");
    var a = t && uo(vt(t), r);
    var n = Lr(e, "content.xml");
    if (!n) throw new Error("Missing content.xml in ODS / UOF file");
    var s = ho(vt(n), r, a);
    if (Pr(e, "meta.xml")) s.Props = Ln(Rr(e, "meta.xml"));
    s.bookType = "ods";
    return s;
  }
  function po(e, r) {
    ...
    e: {
      ...
      if (e[i] == '"') {
        ...
        if (e[i + 1] == "*") {
          ...
          a += "<number:text>" + nt(s.replace(/""/g, '"')) + "</number:text>";
        }
        e = e.slice(i + 1);
        i = 0;
      }
      ...
      if (["y", "m", "d"].indexOf(e[0]) > -1) {
        ...
        r: for (; i < e.length; ++i)
          switch ((s = e[i].toLowerCase())) {
            ...
            case "y":
            case "d":
              while ((e[++i] || "").toLowerCase() == s[0]) s += s[0];
              --i;
              switch (s) {
                case "y":
                case "yy":
  ...
  var wo = (function () {
    ...
    var a = function (a, n, s, i, l) {
      ...
      if (a["!cols"]) {
        for (f = 0; f <= u.e.c; ++f)
          o.push(
            "        <table:table-column" +
              (a["!cols"][f]
                ? ' table:style-name="co' + a["!cols"][f].ods + '"'
                : "") +
              "></table:table-column>\n"
          );
      }
      var p = "",
        v = a["!rows"] || [];
      for (c = 0; c < u.s.r; ++c) {
        p = v[c] ? ' table:style-name="ro' + v[c].ods + '"' : "";
        o.push("        <table:table-row" + p + "></table:table-row>\n");
      }
      for (; c <= u.e.r; ++c) {
        p = v[c] ? ' table:style-name="ro' + v[c].ods + '"' : "";
        o.push("        <table:table-row" + p + ">\n");
        ...
        for (; f <= u.e.c; ++f) {
          ...
          switch (y.t) {
            ...
            case "str":
              ...
              break;
            case "d":
              w = y.w || yr(y.v).toISOString();
              b["office:value-type"] = "date";
              b["office:date-value"] = yr(y.v).toISOString();
          ...
          if (y.l && y.l.Target) {
            var C = y.l.Target;
            C = C.charAt(0) == "#" ? "#" + Pi(C.slice(1)) : C;
            if (C.charAt(0) != "#" && !C.match(/^\w+:/)) C = "../" + C;
            S = Ft("text:a", S, { "xlink:href": C.replace(/&/g, "&amp;") });
          }
          if (l[y.z]) b["table:style-name"] = "ce" + l[y.z].slice(1);
          o.push(
            "          " + Ft("table:table-cell", Ft("text:p", S, {}), b) + "\n"
          );
        }
        o.push("        </table:table-row>\n");
      }
      if ((n.Workbook || {}).Names)
        o.push(bo(n.Workbook.Names, n.SheetNames, s));
      o.push("      </table:table>\n");
      return o.join("");
    };
    var n = function (e, r) {
      ...
      r.SheetNames.map(function (e) {
        ...
        for (var i = 0; i <= a.e.r; ++i)
          for (var l = 0; l <= a.e.c; ++l) {
            var o = t ? (r["!data"][i] || [])[l] : r[La({ r: i, c: l })];
    ...
    return function s(e, r) {
      ...
      for (var o = 0; o != e.SheetNames.length; ++o)
        t.push(a(e.Sheets[e.SheetNames[o]], e, o, r, l));
      if ((e.Workbook || {}).Names)
        t.push(bo(e.Workbook.Names, e.SheetNames, -1));
      t.push("    </office:spreadsheet>\n");
      t.push("  </office:body>\n");
  ...
  function ko(e, r) {
    if (r.bookType == "fods") return wo(e, r);
    var t = Wr();
    var a = "";
    var n = [];
    var s = [];
  ...
  function Co(e) {
    if (Sn.WS.indexOf(e) > -1) return "sheet";
    if (Sn.CS && e == Sn.CS) return "chart";
    if (Sn.DS && e == Sn.DS) return "dialog";
    if (Sn.MS && e == Sn.MS) return "macro";
  ...
  function _o(e, r) {
    ...
    try {
      e = r.map(function a(r) {
        ...
        return [r.name, e["!id"][r.id].Target, Co(e["!id"][r.id].Type)];
      });
    } catch (t) {
      return null;
    }
  ...
  function Ao(e, r, t, a, n, s, i, l, o, c, f, u) {
    try {
      s[a] = _n(Lr(e, t, true), r);
      var h = Rr(e, r);
      var d;
      switch (l) {
        case "sheet":
          ...
          break;
        case "chart":
          d = jl(h, r, n, o, s[a], c, f, u);
          if (!d || !d["!drawel"]) break;
          var m = jr(d["!drawel"].Target, r);
          var p = Cn(m);
      ...
      var w = [],
        k = [];
      if (s && s[a])
        ir(s[a]).forEach(function (t) {
          var n = "";
          if (s[a][t].Type == Sn.CMNT) {
            n = jr(s[a][t].Target, r);
            w = Yl(Rr(e, n, true), n, o);
            if (!w || !w.length) return;
            ci(d, w, false);
          }
          if (s[a][t].Type == Sn.TCMNT) {
            n = jr(s[a][t].Target, r);
            k = k.concat(hi(Rr(e, n, true), o));
          }
        });
      if (k && k.length) ci(d, k, true, o.people || []);
    } catch (y) {
      if (o.WTF) throw y;
    }
  }
  ...
  function Eo(e, r) {
    ...
    r = r || {};
    xo(r);
    if (Pr(e, "META-INF/manifest.xml")) return mo(e, r);
    if (Pr(e, "objectdata.xml")) return mo(e, r);
    ...
    if (!Pr(e, "[Content_Types].xml")) {
      if (Pr(e, "index.xml.gz")) throw new Error("Unsupported NUMBERS 08 file");
      if (Pr(e, "index.xml")) throw new Error("Unsupported NUMBERS 09 file");
      ...
      if (a) {
        ...
        if (typeof Bun !== "undefined" && Buffer.isBuffer(a.content))
          return $o(new Uint8Array(a.content), r);
        return $o(a.content, r);
      }
    ...
    if (s.workbooks.length === 0) {
      o = "xl/workbook.xml";
      if (Rr(e, o, true)) s.workbooks.push(o);
    }
    if (s.workbooks.length === 0) {
      o = "xl/workbook.bin";
      if (!Rr(e, o, true)) throw new Error("Could not find workbook");
      s.workbooks.push(o);
      i = true;
    }
    if (s.workbooks[0].slice(-3) == "bin") i = true;
    var c = {};
    var f = {};
    if (!r.bookSheets && !r.bookProps) {
      ...
      if (s.sst)
        try {
          Ii = Gl(Rr(e, Fo(s.sst)), s.sst, r);
        } catch (u) {
          if (r.WTF) throw u;
        }
      if (r.cellStyles && s.themes.length)
        c = ei(Lr(e, s.themes[0].replace(/^\//, ""), true) || "", r);
      if (s.style) f = Xl(Rr(e, Fo(s.style)), s.style, c, r);
    }
    s.links.map(function (t) {
      try {
        var a = _n(Lr(e, Cn(Fo(t))), t);
        return Kl(Rr(e, Fo(t)), a, t, r);
      } catch (n) {}
    });
    var h = Wl(Rr(e, Fo(s.workbooks[0])), s.workbooks[0], r);
    var d = {},
      m = "";
    if (s.coreprops.length) {
      m = Rr(e, Fo(s.coreprops[0]), true);
      if (m) d = Ln(m);
      if (s.extprops.length !== 0) {
        m = Rr(e, Fo(s.extprops[0]), true);
        if (m) jn(m, d, r);
      }
    }
    var p = {};
    ...
    if (r.bookDeps && s.calcchain)
      g = Jl(Rr(e, Fo(s.calcchain)), s.calcchain, r);
    var b = 0;
    var w = {};
    var k, y;
    {
    ...
    var A = (
      s.workbooks[0].slice(0, _ + 1) +
      "_rels/" +
      s.workbooks[0].slice(_ + 1) +
      ".rels"
    ).replace(/^\//, "");
    if (!Pr(e, A)) A = "xl/_rels/workbook." + C + ".rels";
    var F = _n(Lr(e, A, true), A.replace(/_rels.*/, "s5s"));
    if ((s.metadata || []).length >= 1) {
      r.xlmeta = Zl(Rr(e, Fo(s.metadata[0])), s.metadata[0], r);
    }
    if ((s.people || []).length >= 1) {
      r.people = mi(Rr(e, Fo(s.people[0])), r);
    }
    if (F) F = _o(F, h.Sheets);
    var E = Rr(e, "xl/worksheets/sheet.xml", true) ? 1 : 0;
    e: for (b = 0; b != d.Worksheets; ++b) {
      var T = "sheet";
      if (F && F[b]) {
        k = "xl/" + F[b][1].replace(/[\/]?xl\//, "");
        if (!Pr(e, k)) k = F[b][1];
        if (!Pr(e, k)) k = A.replace(/_rels\/.*$/, "") + F[b][1];
        T = F[b][2];
      } else {
      ...
      Ao(e, k, y, d.SheetNames[b], b, w, l, T, r, h, c, f);
    }
    v = {
      Directory: s,
      Workbook: h,
    ...
    if (r && r.bookVBA) {
      if (s.vba.length > 0) v.vbaraw = Rr(e, Fo(s.vba[0]), true);
      else if (s.defaults && s.defaults.bin === vi)
        v.vbaraw = Rr(e, "xl/vbaProject.bin", true);
    }
    v.bookType = i ? "xlsb" : "xlsx";
    return v;
  }
  function To(e, r) {
    var t = r || {};
    ...
    try {
      ...
      if (!n || !n.content)
        throw new Error("ECMA-376 Encrypted file missing " + a);
      var s = parse_DataSpaceMap(n.content);
      if (
        s.length !== 1 ||
        s[0].comps.length !== 1 ||
        s[0].comps[0].t !== 0 ||
      ...
      if (!n || !n.content)
        throw new Error("ECMA-376 Encrypted file missing " + a);
      var i = parse_DataSpaceDefinition(n.content);
  ...
  function Do(e, r) {
    ...
    var i = "",
      l = 0;
    r.cellXfs = [];
    Wi(r.cellXfs, {}, { revssf: { General: 0 } });
    if (!e.Props) e.Props = {};
    i = "docProps/core.xml";
    $r(s, i, zn(e.Props, r));
    n.coreprops.push(i);
    Fn(r.rels, 2, i, Sn.CORE_PROPS);
    i = "docProps/app.xml";
    ...
    $r(s, i, Hn(e.Props, r));
    n.extprops.push(i);
    Fn(r.rels, 3, i, Sn.EXT_PROPS);
    if (e.Custprops !== e.Props && ir(e.Custprops || {}).length > 0) {
      i = "docProps/custom.xml";
      $r(s, i, Gn(e.Custprops, r));
      n.custprops.push(i);
      Fn(r.rels, 4, i, Sn.CUST_PROPS);
    }
    for (l = 1; l <= e.SheetNames.length; ++l) {
      ...
      switch (h) {
        case "chart":
        default:
          i = "xl/worksheets/sheet" + l + "." + t;
          $r(s, i, write_ws_bin(l - 1, r, e, f));
          n.sheets.push(i);
          Fn(r.wbrels, -1, "worksheets/sheet" + l + "." + t, Sn.WS[0]);
      }
      if (u) {
        var d = u["!comments"];
        var m = false;
        ...
        if (d && d.length > 0) {
          p = "xl/comments" + l + "." + t;
          $r(s, p, write_comments_bin(d, r));
          n.comments.push(p);
          Fn(f, -1, "../comments" + l + "." + t, Sn.CMNT);
          m = true;
        }
        if (u["!legacy"]) {
          if (m)
            $r(s, "xl/drawings/vmlDrawing" + l + ".vml", li(l, u["!comments"]));
        }
        delete u["!comments"];
        delete u["!legacy"];
      }
      if (f["!id"].rId1) $r(s, Cn(i), An(f));
    }
    if (r.Strings != null && r.Strings.length > 0) {
      i = "xl/sharedStrings." + t;
      $r(s, i, write_sst_bin(r.Strings, r));
      n.strs.push(i);
      Fn(r.wbrels, -1, "sharedStrings." + t, Sn.SST);
    }
    i = "xl/workbook." + t;
    $r(s, i, write_wb_bin(e, r));
    n.workbooks.push(i);
    Fn(r.rels, 1, i, Sn.WB);
    ...
    $r(s, i, v);
    n.themes.push(i);
    Fn(r.wbrels, -1, "theme/theme1.xml", Sn.THEME);
    i = "xl/styles." + t;
    $r(s, i, write_sty_bin(e, r));
    n.styles.push(i);
    Fn(r.wbrels, -1, "styles." + t, Sn.STY);
    if (e.vbaraw && a) {
      i = "xl/vbaProject.bin";
      $r(s, i, e.vbaraw);
      n.vba.push(i);
      Fn(r.wbrels, -1, "vbaProject.bin", Sn.VBA);
    }
    i = "xl/metadata." + t;
    $r(s, i, write_xlmeta_bin());
    n.metadata.push(i);
    Fn(r.wbrels, -1, "metadata." + t, Sn.XLMETA);
    $r(s, "[Content_Types].xml", xn(n, r));
    $r(s, "_rels/.rels", An(r.rels));
    $r(s, "xl/_rels/workbook." + t + ".rels", An(r.wbrels));
    delete r.revssf;
    delete r.ssf;
    return s;
  }
  function Oo(e, r) {
    ...
    for (l = 1; l <= e.SheetNames.length; ++l) {
      ...
      if (h) {
        ...
        if (m && m.length > 0) {
          ...
          $r(s, v, ui(m, r));
          n.comments.push(v);
          Fn(u, -1, "../comments" + l + "." + t, Sn.CMNT);
          p = true;
        }
        if (h["!legacy"]) {
          if (p)
            $r(s, "xl/drawings/vmlDrawing" + l + ".vml", li(l, h["!comments"]));
        }
        delete h["!comments"];
        delete h["!legacy"];
      }
      if (u["!id"].rId1) $r(s, Cn(i), An(u));
    }
    if (r.Strings != null && r.Strings.length > 0) {
      i = "xl/sharedStrings." + t;
      $r(s, i, ds(r.Strings, r));
      n.strs.push(i);
      Fn(r.wbrels, -1, "sharedStrings." + t, Sn.SST);
    }
    i = "xl/workbook." + t;
    ...
    if (f.length > 1) {
      ...
      $r(s, i, pi(f, r));
      n.people.push(i);
      Fn(r.wbrels, -1, "persons/person.xml", Sn.PEOPLE);
    }
    $r(s, "[Content_Types].xml", xn(n, r));
    $r(s, "_rels/.rels", An(r.rels));
    $r(s, "xl/_rels/workbook." + t + ".rels", An(r.wbrels));
  ...
  function No(e, r) {
    if (er.find(e, "EncryptedPackage")) return To(e, r);
  ...
  function zo(e, r, t, a) {
    if (a) {
      t.type = "string";
      return Qn.to_workbook(e, t);
    }
    return Qn.to_workbook(r, t);
  }
  function $o(e, r) {
    c();
    var t = r || {};
    ...
    if (typeof ArrayBuffer !== "undefined" && e instanceof ArrayBuffer)
      return $o(new Uint8Array(e), ((t = Sr(t)), (t.type = "array"), t));
    ...
    Ri = {};
    if (t.dateNF) Ri.dateNF = t.dateNF;
    ...
    switch ((s = Mo(n, t))[0]) {
      ...
      case 73:
        ...
        if (s[1] === 68) return es(n, t);
        break;
      case 84:
        if (s[1] === 65 && s[2] === 66 && s[3] === 76)
          return Zn.to_workbook(n, t);
        break;
      case 80:
        return s[1] === 75 && s[2] < 9 && s[3] < 9 ? Po(n, t) : zo(e, n, t, i);
      case 239:
        return s[3] === 60 ? parse_xlml(n, t) : zo(e, n, t, i);
      case 255:
        if (s[1] === 254) {
          return Lo(n, t);
        } else if (s[1] === 0 && s[2] === 2 && s[3] === 0)
          return WK_.to_workbook(n, t);
        break;
      case 0:
        if (s[1] === 0) {
          if (s[2] >= 2 && s[3] === 0) return WK_.to_workbook(n, t);
      ...
      case 8:
        ...
        break;
      case 12:
        if (s[1] === 236) throw new Error("Unsupported Multiplan 2.x file!");
        if (s[1] === 237) throw new Error("Unsupported Multiplan 3.x file!");
        break;
    }
    if (Yn.indexOf(s[0]) > -1 && s[2] <= 12 && s[3] <= 31)
      return Jn.to_workbook(n, t);
    return zo(e, n, t, i);
  }
  function Wo(e, r) {
  ...
  function Uo(e, r) {
    switch (r.type) {
      ...
      case "array":
        ...
        break;
      case "file":
        return nr(r.file, er.write(e, { type: S ? "buffer" : "" }));
      case "string":
        throw new Error(
  ...
  function qo(e, r) {
    ...
    switch (t.bookType || "xlsb") {
      case "xml":
      case "xlml":
        return Yo(write_xlml(e, t), t);
      case "slk":
      case "sylk":
        return Yo(Kn.from_sheet(e.Sheets[e.SheetNames[n]], t, e), t);
      case "htm":
      case "html":
        return Yo(no(e.Sheets[e.SheetNames[n]], t), t);
      case "txt":
        return Jo(oc(e.Sheets[e.SheetNames[n]], t), t);
      case "csv":
        return Yo(lc(e.Sheets[e.SheetNames[n]], t), t, "\ufeff");
      case "dif":
        return Yo(Zn.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
      case "dbf":
        return Ko(Jn.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
      case "prn":
        return Yo(Qn.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
      case "rtf":
        return Yo(sheet_to_rtf(e.Sheets[e.SheetNames[n]], t), t);
      case "eth":
        return Yo(qn.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
      case "fods":
        return Yo(ko(e, t), t);
      case "wk1":
        return Ko(WK_.sheet_to_wk1(e.Sheets[e.SheetNames[n]], t), t);
      case "wk3":
        return Ko(WK_.book_to_wk3(e, t), t);
      case "biff2":
        if (!t.biff) t.biff = 2;
      case "biff3":
        if (!t.biff) t.biff = 3;
      case "biff4":
        if (!t.biff) t.biff = 4;
        return Ko(write_biff_buf(e, t), t);
      case "biff5":
        if (!t.biff) t.biff = 5;
      case "biff8":
      case "xla":
  ...
  function tc(e, r, t, a) {
    ...
    n.type = "buffer";
    var s = a;
    if (!(s instanceof Function)) s = t;
    return rr.writeFile(e, qo(r, n), s);
  }
  function ac(e, r, t, a, n, s, i) {
    var l = Ea(t);
    var o = i.defval,
    ...
    if (!u || e["!data"][t])
      for (var m = r.s.c; m <= r.e.c; ++m) {
        ...
        if (s[m] != null) {
          if (v == null) {
            if (p.t == "e" && v === null) h[s[m]] = null;
            else if (o !== undefined) h[s[m]] = o;
            else if (c && v === null) h[s[m]] = null;
            else continue;
          } else {
            h[s[m]] =
              c && (p.t !== "n" || (p.t === "n" && i.rawNumbers !== false))
                ? v
                : Ha(p, v, i);
          }
          if (v != null) f = false;
  ...
  function ic(e, r, t, a, n, s, i, l) {
    ...
    for (var m = r.s.c; m <= r.e.c; ++m) {
      ...
      if (p == null) f = "";
        ...
        o = false;
        f = "" + (l.rawNumbers && p.t == "n" ? p.v : Ha(p, null, l));
  ...
  function lc(e, r) {
    ...
    for (var m = n.s.c; m <= n.e.c; ++m) if (!(h[m] || {}).hidden) u[m] = Ma(m);
    var p = 0;
    for (var v = n.s.r; v <= n.e.r; ++v) {
      if ((d[v] || {}).hidden) continue;
      f = ic(e, n, v, u, i, o, s, a);
      if (f == null) {
        continue;
      }
      if (a.strip) f = f.replace(c, "");
      if (f || a.blankrows !== false) t.push((p++ ? l : "") + f);
    }
    return t.join("");
  }
  function oc(e, r) {
  ...
  function cc(e) {
    ...
    var o = [];
    var c = e["!data"] != null;
    for (l = n.s.c; l <= n.e.c; ++l) i[l] = Ma(l);
  ...
  function fc(e, r, t) {
    ...
    if (i && a.origin != null) {
      if (typeof a.origin == "number") l = a.origin;
        ...
        var c = typeof a.origin == "string" ? Ra(a.origin) : a.origin;
        l = c.r;
        o = c.c;
      }
    }
    var f = { s: { c: 0, r: 0 }, e: { c: o, r: l + r.length - 1 + s } };
    if (i["!ref"]) {
      var u = Ua(i["!ref"]);
      f.e.c = Math.max(f.e.c, u.e.c);
      f.e.r = Math.max(f.e.r, u.e.r);
    ...
    r.forEach(function (e, r) {
      if (n && !i["!data"][l + r + s]) i["!data"][l + r + s] = [];
      if (n) m = i["!data"][l + r + s];
      ir(e).forEach(function (t) {
        ...
        if (c && typeof c === "object" && !(c instanceof Date)) {
          ...
          if (typeof c == "number") f = "n";
            ...
            u = v != null && v.z && Le(v.z) ? v.z : a.dateNF || K[14];
    ...
    var p = Ea(l);
    if (n && !i["!data"][l]) i["!data"][l] = [];
    if (s)
      for (d = 0; d < h.length; ++d) {
        if (n) i["!data"][l][d + o] = { t: "s", v: h[d] };
        else i[Ma(d + o) + p] = { t: "s", v: h[d] };
      }
    i["!ref"] = za(f);
    return i;
  }
  ...
  function hc(e, r, t) {
    ...
    if (typeof r != "number") return hc(e, La(r));
    return hc(e, Ma(t || 0) + Ea(r));
  }
  function dc(e, r) {
    if (typeof r == "number") {
  ...
  function pc(e, r, t, a) {
    ...
    if (a && e.SheetNames.indexOf(t) >= 0) {
      ...
      var i = (s && s[1]) || t;
      for (++n; n <= 65535; ++n)
        if (e.SheetNames.indexOf((t = i + n)) == -1) break;
    }
    Il(t);
  ...
  var xc = {
    ...
    sheet_to_json: nc,
    sheet_to_html: no,
    sheet_to_formulae: cc,
    sheet_to_row_object_array: nc,
    sheet_get_cell: hc,
    book_new: mc,
    book_append_sheet: pc,
    book_set_sheet_visibility: vc,
    cell_set_number_format: gc,
    cell_set_hyperlink: bc,
    cell_set_internal_link: wc,
    cell_add_comment: kc,
    sheet_set_array_formula: yc,
  ...
  if (typeof require !== "undefined") {
    var Sc = undefined;
    if ((Sc || {}).Readable) set_readable(Sc.Readable);
    try {
      rr = undefined;
    } catch (Cc) {}
  }
