...
import { walletCount, showWallets, newWalletsFragment, newIncorrectsWalletsFragment, renameNumberOfWallets } from "./manualWallets.js";
...
export function addIncorrectWalletElement(wallet, amount, typeOfToken, whatError) {
    ...
    switch (whatError) {
        case "wallet error":
            newWalletErrorsContainer.innerHTML =
                walleterrorElement + onlyWalletError;
            break;
        case "amount error":
            newWalletErrorsContainer.innerHTML =
                walleterrorElement + onlyAmountError;
            break;
        case "all errors":
