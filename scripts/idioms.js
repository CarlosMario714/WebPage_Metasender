export default {
    ...
    es: {
        "navbar": {
            ...
            "navbar-send": "ENVIAR",
            "navbar-palco": "PALCO",
            "navbar-connect": "CONNECTAR WALLET <img src=\"./img/icons/Metamask-icon.png\"alt=\"icono metamask\">"
        },
        "header": {
            "header-slogan-subtitle": "Una DApp de Metalorian"
        },
        "description": {
        ...
        "send-process": {
            ...
            "send-process-template-condition1": "*Cada dato en el archivo no debe contener espacios en blanco",
            "send-process-template-condition2": "*Si vas a enviar ERC721, en la columna de monto debes indicar el ID del token a enviar",
            ...
            "send-process-resume-tokenBalance": "Su Salde en tokens",
            ...
            "send-process-aproval-text": "<span>El MetaSender</span> requiere su <span>aprobación</span> para transferir sus tokens a las direcciones agregadas y continuar con el siguiente paso de la operación:",
